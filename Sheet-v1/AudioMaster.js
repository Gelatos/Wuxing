...
//		log('  >Tracks updated<');
    ...
    makeImageButton = function(command, image, toolTip, backgroundColor,size){
        return '<a href="'+command+'" title= "'+toolTip+'" style="margin:0;padding:1px;border:0px solid;background-color:'+backgroundColor+'"><span style="color:black;padding:0px;font-size:'+size+'px;font-family: \'Pictos\'">'+image+'</span></a>'
    },
    ...
    //******************************************************************************************************************************   
    inputController = function(msg_orig) {
...
// 	},
    ...
    RegisterEventHandlers = function() {
        // on('chat:message', inputController);
    ...
    return {
        ...
        StopAll: stopAll,
        RemoveJukebox : removeJukebox,
        ImportJukebox : importJukebox
	}
