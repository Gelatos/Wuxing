var WuxDef = WuxDef || (function () {
	...
	var
		...
		values = {
			...
			"Archetype_Vanguard": {
				"name": "Archetype_Vanguard", "fieldName": "vanguard", "group": "Archetype", "description": "", "variable": "arc-vanguard{0}", "title": "Vanguard", "subGroup": "", "descriptions": ["Defense:Brace(++).Reflex(+) Sense:Resolve(++)"],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			"Archetype_Athlete": {
				"name": "Archetype_Athlete", "fieldName": "athlete", "group": "Archetype", "description": "", "variable": "arc-athlete{0}", "title": "Athlete", "subGroup": "", "descriptions": ["Defense:Refex(+++) Sense:Resolve(++)"],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			"Archetype_Marksman": {
				"name": "Archetype_Marksman", "fieldName": "marksman", "group": "Archetype", "description": "", "variable": "arc-marksman{0}", "title": "Marksman", "subGroup": "", "descriptions": ["Defense:Reflex(++).Disruption(+) Sense:Guile(++)"],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			"Archetype_Mage": {
				"name": "Archetype_Mage", "fieldName": "mage", "group": "Archetype", "description": "", "variable": "arc-mage{0}", "title": "Mage", "subGroup": "", "descriptions": ["Defense:Brace(+).Disruption(++) Sense:Resolve(++).Insight(+)"],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			"Archetype_Strategist": {
				"name": "Archetype_Strategist", "fieldName": "strategist", "group": "Archetype", "description": "", "variable": "arc-strategist{0}", "title": "Strategist", "subGroup": "", "descriptions": ["Defense:Disruption(++) Sense:Insight(++).Guile(++)"],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			"Archetype_Advocate": {
				"name": "Archetype_Advocate", "fieldName": "advocate", "group": "Archetype", "description": "", "variable": "arc-advocate{0}", "title": "Advocate", "subGroup": "", "descriptions": ["Defense:Reflex(++) Sense:Insight(+++)"],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			"Archetype_Waymaker": {
				"name": "Archetype_Waymaker", "fieldName": "waymaker", "group": "Archetype", "description": "", "variable": "arc-waymaker{0}", "title": "Waymaker", "subGroup": "", "descriptions": ["Defense:Brace(++).Reflex(+) Sense:Insight(++).Guile(+)"],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			...
			"Tech_Follow Through": {
				"name": "Tech_Follow Through", "fieldName": "tech_follow_through", "group": "Technique", "description": "", "variable": "tch-follow_through{0}", "title": "Follow Through", "subGroup": "Brawler", "descriptions": [""],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": {
					"workers": [{ "variableName": "adv-level", "definitionName": "Level", "value": 0, "multiplier": 1, "max": 4 },
					{ "variableName": "adv-cr", "definitionName": "CR", "value": 0, "multiplier": 3, "max": 0 },
					{ "variableName": "adv-ap_technique", "definitionName": "AdvancementTechnique", "value": 0, "multiplier": 1, "max": 0 },
			...
			"Tech_Ki Steps": {
				"name": "Tech_Ki Steps", "fieldName": "tech_ki_steps", "group": "Technique", "description": "", "variable": "tch-ki_steps{0}", "title": "Ki Steps", "subGroup": "Kineticist", "descriptions": [""],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": {
					"workers": [{ "variableName": "adv-level", "definitionName": "Level", "value": 0, "multiplier": 1, "max": 4 },
					{ "variableName": "adv-cr", "definitionName": "CR", "value": 0, "multiplier": 3, "max": 0 },
					{ "variableName": "adv-ap_technique", "definitionName": "AdvancementTechnique", "value": 0, "multiplier": 1, "max": 0 },
