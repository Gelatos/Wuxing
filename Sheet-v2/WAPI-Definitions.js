    ...
    var
        ...
        values = {"Attribute":{"name":"Attribute","fieldName":"attribute","group":"Type","description":"","variable":"atr{0}{1}","title":"Attributes","subGroup":"","descriptions":[""],
            ...
            "Style_Glass Blades":{"name":"Style_Glass Blades","fieldName":"style_glass_blades","group":"Style","description":"","variable":"sty-glass_blades{0}","title":"Glass Blades","subGroup":"Battlesmithing","descriptions":["Fire. A Conjure-focused style with fast creating glass to hinder and cut."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","baseStyle":"Conjure Blades","tier":null},
            ...
            "Job_Fighter":{"name":"Job_Fighter","fieldName":"job_fighter","group":"Job","description":"","variable":"job-fighter{0}","title":"Fighter","subGroup":"Vanguard","descriptions":["A high survival weapon specialist that gains bonuses by being healed."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Brace(+++).Reflx. Sens:Reslv(++)."},
            "Job_Brawler":{"name":"Job_Brawler","fieldName":"job_brawler","group":"Job","description":"","variable":"job-brawler{0}","title":"Brawler","subGroup":"Athlete","descriptions":["A melee mobile attacker that creates and exploits weaknesses in their foes to overwhelm them."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[]
                ,
                "isResource":"","skills":"Grappling","requirements":"None","defenses":"Defs:Brace.Reflx(++). Sens:Reslv(++)."},
            "Job_Labourer":{"name":"Job_Labourer","fieldName":"job_labourer","group":"Job","description":"","variable":"job-labourer{0}","title":"Labourer","subGroup":"Athlete","descriptions":["A brawny worker with strong sustain abilities allowing them to endure powerful abilities and maintain focus."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Brace(++).Reflx.Fort(++). Sens:Reslv(++)."},
            "Job_Sentinel":{"name":"Job_Sentinel","fieldName":"job_sentinel","group":"Job","description":"","variable":"job-sentinel{0}","title":"Sentinel","subGroup":"Vanguard","descriptions":["A mobile melee attacker that intercepts attacks and retaliates against the foe."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Might","requirements":"None","defenses":"Defs:Brace(++).Reflx(+). Sens:Insght(++).Notice."},
            "Job_Warden":{"name":"Job_Warden","fieldName":"job_warden","group":"Job","description":"","variable":"job-warden{0}","title":"Warden","subGroup":"Vanguard","descriptions":["A mage that creates mantles around themselves and allies to reduce or negate incoming damage."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Channel","requirements":"None","defenses":"Defs:Brace.Ward.Reflx(++). Sens:Reslv(++)."},
            "Job_Bulwark":{"name":"Job_Bulwark","fieldName":"job_bulwark","group":"Job","description":"","variable":"job-bulwark{0}","title":"Bulwark","subGroup":"Vanguard","descriptions":["A defensive magic specialist that creates walls to protect allies and provide cover."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Conjure","requirements":"None","defenses":"Defs:Brace.Ward(++).Reflx. Sens:Insght(++)."},
            "Job_Exemplar":{"name":"Job_Exemplar","fieldName":"job_exemplar","group":"Job","description":"","variable":"job-exemplar{0}","title":"Exemplar","subGroup":"Athlete","descriptions":["A mobility specialist that concentrates ki into a burst to attack and maneuver foes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Skirmish","requirements":"None","defenses":""},
            "Job_Kineticist":{"name":"Job_Kineticist","fieldName":"job_kineticist","group":"Job","description":"","variable":"job-kineticist{0}","title":"Kineticist","subGroup":"Athlete","descriptions":["A ranged attacker that uses kinetic magic to force their foes to the ground and retain high mobility with kinetic attacks."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Kinesis","requirements":"None","defenses":"Defs:Reflx(+++).Evade. Sens:Guile(++)."},
            "Job_Rogue":{"name":"Job_Rogue","fieldName":"job_rogue","group":"Job","description":"","variable":"job-rogue{0}","title":"Rogue","subGroup":"Athlete","descriptions":["A cloaking specialist that attacks in melee to exploit damage before ducking back into cover."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Reflx(++).Evade(++).Hide. Sens:Insght(++)."},
            "Job_Hunter":{"name":"Job_Hunter","fieldName":"job_hunter","group":"Job","description":"","variable":"job-hunter{0}","title":"Hunter","subGroup":"Operator","descriptions":["A ranged attacker that chooses a quarry to hunt down and focus fire."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shoot","requirements":"None","defenses":"Defs:Brace.Reflx(++). Sens:Guile(++).Notice."},
            "Job_Sniper":{"name":"Job_Sniper","fieldName":"job_sniper","group":"Job","description":"","variable":"job-sniper{0}","title":"Sniper","subGroup":"Operator","descriptions":["A long range attacker that wants to gain as much distance as possible to attack from safety."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shoot","requirements":"None","defenses":"Defs:Ward(++).Reflx. Sens:Insght(++).Notice."},
            "Job_Trooper":{"name":"Job_Trooper","fieldName":"job_trooper","group":"Job","description":"","variable":"job-trooper{0}","title":"Trooper","subGroup":"Operator","descriptions":["A ranged specialist that assigns areas to overwatch and prepare attacks for those that enter their area."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shoot","requirements":"None","defenses":"Defs:Brace.Ward.Reflx. Sens:Insght(++).Notice."},
            "Job_Warmage":{"name":"Job_Warmage","fieldName":"job_warmage","group":"Job","description":"","variable":"job-warmage{0}","title":"Warmage","subGroup":"Operator","descriptions":["An area attacker that specializes in magic that attacks large groups of people."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Brace.Reflx(++). Sens:Reslv(++).Notice."},
            "Job_Alchemist":{"name":"Job_Alchemist","fieldName":"job_alchemist","group":"Job","description":"","variable":"job-alchemist{0}","title":"Alchemist","subGroup":"Operator","descriptions":["A master of consumables that can aid allies with healing and hinder foes with bombs. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Ward(++).Reflx. Sens:Guile(++).Notice."},
            "Job_Geomancer":{"name":"Job_Geomancer","fieldName":"job_geomancer","group":"Job","description":"","variable":"job-geomancer{0}","title":"Geomancer","subGroup":"Athlete","descriptions":["A terrain molding job that gains benefits when foes enter their areas of control."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shape","requirements":"None","defenses":""},
            "Job_Magus":{"name":"Job_Magus","fieldName":"job_magus","group":"Job","description":"","variable":"job-magus{0}","title":"Magus","subGroup":"Strategist","descriptions":["A mage specializing in environmental manipulation, they create fields of arcane energy to hinder foes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Channel; Resonance","requirements":"None","defenses":"Defs:Brace.Ward(++). Sens:Reslv.Guile(+++).Scrtny."},
            "Job_Tactician":{"name":"Job_Tactician","fieldName":"job_tactician","group":"Job","description":"","variable":"job-tactician{0}","title":"Tactician","subGroup":"Strategist","descriptions":["A battlefield commander that repositions their allies into the optimal locations to attack."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Analyze","requirements":"None","defenses":"Defs:Ward(++).Reflx.Evade. Sens:Insght.Guile(++).Scrtny."},
            "Job_Bard":{"name":"Job_Bard","fieldName":"job_bard","group":"Job","description":"","variable":"job-bard{0}","title":"Bard","subGroup":"Waymaker","descriptions":["An entertainer that gives advantages to allies and restores their willpower."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Inspire","requirements":"None","defenses":"Defs:Brace(++).Ward. Sens:Reslv(++).Guile(++)."},
            "Job_Medic":{"name":"Job_Medic","fieldName":"job_medic","group":"Job","description":"","variable":"job-medic{0}","title":"Medic","subGroup":"Waymaker","descriptions":["A powerful healer with the use of a medkit that can heal wounds as soon as they are made."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Medicine","requirements":"None","defenses":"Defs:Ward(++).Reflx.Fort(++). Sens:Reslv(++).Guile."},
            "Job_Etherealist":{"name":"Job_Etherealist","fieldName":"job_etherealist","group":"Job","description":"","variable":"job-etherealist{0}","title":"Etherealist","subGroup":"Esper","descriptions":["A master of spirit communication that can transport themselves to the ethereal plane."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Empathy; Resonance","requirements":"None","defenses":"Defs:Ward.Reflx(++). Sens:Reslv(++).Insght.Free(+++)."},
            "Job_Merchant":{"name":"Job_Merchant","fieldName":"job_merchant","group":"Job","description":"","variable":"job-merchant{0}","title":"Merchant","subGroup":"Advocate","descriptions":["A social expert that convinces others of their requests through charming bargains and tact."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Charm","requirements":"None","defenses":"Defs:Reflx. Sens:Insght(++).Guile(++).Free.Scrtny."},
            "Job_Orator":{"name":"Job_Orator","fieldName":"job_orator","group":"Job","description":"","variable":"job-orator{0}","title":"Orator","subGroup":"Advocate","descriptions":["A socialite that uses misdirection to imply and persuade others into following their requests."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Misdirect","requirements":"None","defenses":"Defs:Ward. Sens:Reslv.Insght(++).Guile.Free(++)."},
            "Job_Hardliner":{"name":"Job_Hardliner","fieldName":"job_hardliner","group":"Job","description":"","variable":"job-hardliner{0}","title":"Hardliner","subGroup":"Advocate","descriptions":["A negotiator that uses pressure tactics to break down will and accelerate a deal. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Misdirect","requirements":"None","defenses":"Defs:Brace. Sens:Reslv.Insght(++).Guile.Free."},
            "Job_Detective":{"name":"Job_Detective","fieldName":"job_detective","group":"Job","description":"","variable":"job-detective{0}","title":"Detective","subGroup":"Waymaker","descriptions":["A seeker of clues and mysteries that gains expanded searching abilities and passive search bonuses."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Search","requirements":"None","defenses":"Defs:Brace(++).Ward. Sens:Reslv(++).Guile(++)."},
            "Job_Inquisitor":{"name":"Job_Inquisitor","fieldName":"job_inquisitor","group":"Job","description":"","variable":"job-inquisitor{0}","title":"Inquisitor","subGroup":"Strategist","descriptions":["An investigator that analyzes people to learn their influences and find the truth."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Analyze","requirements":"None","defenses":"Defs:Reflx. Sens:Insght.Guile(+++).Scrtny."},
            "Job_Empath":{"name":"Job_Empath","fieldName":"job_empath","group":"Job","description":"","variable":"job-empath{0}","title":"Empath","subGroup":"Advocate","descriptions":["An emotion expert that calms stress from will attacks and protects from those that would manipulate."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Empathy","requirements":"None","defenses":"Defs:Ward. Sens:Reslv.Insght(+++).Free."},
            "Job_Scholar":{"name":"Job_Scholar","fieldName":"job_scholar","group":"Job","description":"","variable":"job-scholar{0}","title":"Scholar","subGroup":"Strategist","descriptions":["A collector of lore that gains bonuses when using their information to inform and detect lies."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Rationalize","requirements":"None","defenses":"Defs:Ward. Sens:Insght(++).Guile(++).Scrtny."},
            "Job_Culinarian":{"name":"Job_Culinarian","fieldName":"job_culinarian","group":"Job","description":"","variable":"job-culinarian{0}","title":"Culinarian","subGroup":"Waymaker","descriptions":["A chef that grants benefits to those that consume their meals."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Cook","requirements":"None","defenses":"Defs:Brace. Sens:Reslv.Insght(++)."},
            "Job_Spellwright":{"name":"Job_Spellwright","fieldName":"job_spellwright","group":"Job","description":"","variable":"job-spellwright{0}","title":"Spellwright","subGroup":"Waymaker","descriptions":["A conjuration mage that shapes material into new forms, allowing them to maintain magic that creates objects and changes the terrain."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shape","requirements":"None","defenses":"Defs:Brace(++).Ward. Sens:Reslv.Guile.Notice."},
            "Job_Phantasm":{"name":"Job_Phantasm","fieldName":"job_phantasm","group":"Job","description":"","variable":"job-phantasm{0}","title":"Phantasm","subGroup":"Esper","descriptions":["Spirit Only. Spirits that develop their abilities to manipulate emotion and thought via distracting hallucinations."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Charm; Resonance","requirements":"None","defenses":"Phantasm"},
            "Job_Shade":{"name":"Job_Shade","fieldName":"job_shade","group":"Job","description":"","variable":"job-shade{0}","title":"Shade","subGroup":"Esper","descriptions":["Spirit Only. A spirit that can manifest itself into objects and shadows to scout and attack."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Resonance","requirements":"None","defenses":"Defs:Ward(++).Reflx. Sens:Reslv.Insght(++).Free."},
            "JStyle_Fighter":{"name":"JStyle_Fighter","fieldName":"jstyle_fighter","group":"JobStyle","description":"","variable":"jbs-fighter{0}","title":"Fighter","subGroup":"Vanguard","descriptions":["A high survival weapon specialist that gains bonuses by being healed."],
                ...
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Brace(+++).Reflx. Sens:Reslv(++)."},
            "JStyle_Brawler":{"name":"JStyle_Brawler","fieldName":"jstyle_brawler","group":"JobStyle","description":"","variable":"jbs-brawler{0}","title":"Brawler","subGroup":"Athlete","descriptions":["A melee mobile attacker that creates and exploits weaknesses in their foes to overwhelm them."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Grappling","requirements":"None","defenses":"Defs:Brace.Reflx(++). Sens:Reslv(++)."},
            "JStyle_Labourer":{"name":"JStyle_Labourer","fieldName":"jstyle_labourer","group":"JobStyle","description":"","variable":"jbs-labourer{0}","title":"Labourer","subGroup":"Athlete","descriptions":["A brawny worker with strong sustain abilities allowing them to endure powerful abilities and maintain focus."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Brace(++).Reflx.Fort(++). Sens:Reslv(++)."},
            "JStyle_Sentinel":{"name":"JStyle_Sentinel","fieldName":"jstyle_sentinel","group":"JobStyle","description":"","variable":"jbs-sentinel{0}","title":"Sentinel","subGroup":"Vanguard","descriptions":["A mobile melee attacker that intercepts attacks and retaliates against the foe."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Might","requirements":"None","defenses":"Defs:Brace(++).Reflx(+). Sens:Insght(++).Notice."},
            "JStyle_Warden":{"name":"JStyle_Warden","fieldName":"jstyle_warden","group":"JobStyle","description":"","variable":"jbs-warden{0}","title":"Warden","subGroup":"Vanguard","descriptions":["A mage that creates mantles around themselves and allies to reduce or negate incoming damage."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Channel","requirements":"None","defenses":"Defs:Brace.Ward.Reflx(++). Sens:Reslv(++)."},
            "JStyle_Bulwark":{"name":"JStyle_Bulwark","fieldName":"jstyle_bulwark","group":"JobStyle","description":"","variable":"jbs-bulwark{0}","title":"Bulwark","subGroup":"Vanguard","descriptions":["A defensive magic specialist that creates walls to protect allies and provide cover."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Conjure","requirements":"None","defenses":"Defs:Brace.Ward(++).Reflx. Sens:Insght(++)."},
            ...
            "JStyle_Rogue":{"name":"JStyle_Rogue","fieldName":"jstyle_rogue","group":"JobStyle","description":"","variable":"jbs-rogue{0}","title":"Rogue","subGroup":"Athlete","descriptions":["A cloaking specialist that attacks in melee to exploit damage before ducking back into cover."],
                ...
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Reflx(++).Evade(++).Hide. Sens:Insght(++)."},
            "JStyle_Hunter":{"name":"JStyle_Hunter","fieldName":"jstyle_hunter","group":"JobStyle","description":"","variable":"jbs-hunter{0}","title":"Hunter","subGroup":"Operator","descriptions":["A ranged attacker that chooses a quarry to hunt down and focus fire."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shoot","requirements":"None","defenses":"Defs:Brace.Reflx(++). Sens:Guile(++).Notice."},
            "JStyle_Sniper":{"name":"JStyle_Sniper","fieldName":"jstyle_sniper","group":"JobStyle","description":"","variable":"jbs-sniper{0}","title":"Sniper","subGroup":"Operator","descriptions":["A long range attacker that wants to gain as much distance as possible to attack from safety."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shoot","requirements":"None","defenses":"Defs:Ward(++).Reflx. Sens:Insght(++).Notice."},
            "JStyle_Trooper":{"name":"JStyle_Trooper","fieldName":"jstyle_trooper","group":"JobStyle","description":"","variable":"jbs-trooper{0}","title":"Trooper","subGroup":"Operator","descriptions":["A ranged specialist that assigns areas to overwatch and prepare attacks for those that enter their area."],
                ...
                "linkedGroups":[],
                "isResource":"","skills":"Shoot","requirements":"None","defenses":"Defs:Brace.Ward.Reflx. Sens:Insght(++).Notice."},
            "JStyle_Warmage":{"name":"JStyle_Warmage","fieldName":"jstyle_warmage","group":"JobStyle","description":"","variable":"jbs-warmage{0}","title":"Warmage","subGroup":"Operator","descriptions":["An area attacker that specializes in magic that attacks large groups of people."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Brace.Reflx(++). Sens:Reslv(++).Notice."},
            "JStyle_Alchemist":{"name":"JStyle_Alchemist","fieldName":"jstyle_alchemist","group":"JobStyle","description":"","variable":"jbs-alchemist{0}","title":"Alchemist","subGroup":"Operator","descriptions":["A master of consumables that can aid allies with healing and hinder foes with bombs. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"","requirements":"None","defenses":"Defs:Ward(++).Reflx. Sens:Guile(++).Notice."},
            "JStyle_Geomancer":{"name":"JStyle_Geomancer","fieldName":"jstyle_geomancer","group":"JobStyle","description":"","variable":"jbs-geomancer{0}","title":"Geomancer","subGroup":"Athlete","descriptions":["A terrain molding job that gains benefits when foes enter their areas of control."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shape","requirements":"None","defenses":""},
            "JStyle_Magus":{"name":"JStyle_Magus","fieldName":"jstyle_magus","group":"JobStyle","description":"","variable":"jbs-magus{0}","title":"Magus","subGroup":"Strategist","descriptions":["A mage specializing in environmental manipulation, they create fields of arcane energy to hinder foes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Channel; Resonance","requirements":"None","defenses":"Defs:Brace.Ward(++). Sens:Reslv.Guile(+++).Scrtny."},
            "JStyle_Tactician":{"name":"JStyle_Tactician","fieldName":"jstyle_tactician","group":"JobStyle","description":"","variable":"jbs-tactician{0}","title":"Tactician","subGroup":"Strategist","descriptions":["A battlefield commander that repositions their allies into the optimal locations to attack."],
                ...
                "linkedGroups":[],
                "isResource":"","skills":"Analyze","requirements":"None","defenses":"Defs:Ward(++).Reflx.Evade. Sens:Insght.Guile(++).Scrtny."},
            "JStyle_Bard":{"name":"JStyle_Bard","fieldName":"jstyle_bard","group":"JobStyle","description":"","variable":"jbs-bard{0}","title":"Bard","subGroup":"Waymaker","descriptions":["An entertainer that gives advantages to allies and restores their willpower."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Inspire","requirements":"None","defenses":"Defs:Brace(++).Ward. Sens:Reslv(++).Guile(++)."},
            "JStyle_Medic":{"name":"JStyle_Medic","fieldName":"jstyle_medic","group":"JobStyle","description":"","variable":"jbs-medic{0}","title":"Medic","subGroup":"Waymaker","descriptions":["A powerful healer with the use of a medkit that can heal wounds as soon as they are made."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Medicine","requirements":"None","defenses":"Defs:Ward(++).Reflx.Fort(++). Sens:Reslv(++).Guile."},
            ...
            "JStyle_Hardliner":{"name":"JStyle_Hardliner","fieldName":"jstyle_hardliner","group":"JobStyle","description":"","variable":"jbs-hardliner{0}","title":"Hardliner","subGroup":"Advocate","descriptions":["A negotiator that uses pressure tactics to break down will and accelerate a deal. "],
                ...
                "linkedGroups":[],
                "isResource":"","skills":"Misdirect","requirements":"None","defenses":"Defs:Brace. Sens:Reslv.Insght(++).Guile.Free."},
            "JStyle_Detective":{"name":"JStyle_Detective","fieldName":"jstyle_detective","group":"JobStyle","description":"","variable":"jbs-detective{0}","title":"Detective","subGroup":"Waymaker","descriptions":["A seeker of clues and mysteries that gains expanded searching abilities and passive search bonuses."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Search","requirements":"None","defenses":"Defs:Brace(++).Ward. Sens:Reslv(++).Guile(++)."},
            "JStyle_Inquisitor":{"name":"JStyle_Inquisitor","fieldName":"jstyle_inquisitor","group":"JobStyle","description":"","variable":"jbs-inquisitor{0}","title":"Inquisitor","subGroup":"Strategist","descriptions":["An investigator that analyzes people to learn their influences and find the truth."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Analyze","requirements":"None","defenses":"Defs:Reflx. Sens:Insght.Guile(+++).Scrtny."},
            "JStyle_Empath":{"name":"JStyle_Empath","fieldName":"jstyle_empath","group":"JobStyle","description":"","variable":"jbs-empath{0}","title":"Empath","subGroup":"Advocate","descriptions":["An emotion expert that calms stress from will attacks and protects from those that would manipulate."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Empathy","requirements":"None","defenses":"Defs:Ward. Sens:Reslv.Insght(+++).Free."},
            "JStyle_Scholar":{"name":"JStyle_Scholar","fieldName":"jstyle_scholar","group":"JobStyle","description":"","variable":"jbs-scholar{0}","title":"Scholar","subGroup":"Strategist","descriptions":["A collector of lore that gains bonuses when using their information to inform and detect lies."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Rationalize","requirements":"None","defenses":"Defs:Ward. Sens:Insght(++).Guile(++).Scrtny."},
            "JStyle_Culinarian":{"name":"JStyle_Culinarian","fieldName":"jstyle_culinarian","group":"JobStyle","description":"","variable":"jbs-culinarian{0}","title":"Culinarian","subGroup":"Waymaker","descriptions":["A chef that grants benefits to those that consume their meals."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Cook","requirements":"None","defenses":"Defs:Brace. Sens:Reslv.Insght(++)."},
            "JStyle_Spellwright":{"name":"JStyle_Spellwright","fieldName":"jstyle_spellwright","group":"JobStyle","description":"","variable":"jbs-spellwright{0}","title":"Spellwright","subGroup":"Waymaker","descriptions":["A conjuration mage that shapes material into new forms, allowing them to maintain magic that creates objects and changes the terrain."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","skills":"Shape","requirements":"None","defenses":"Defs:Brace(++).Ward. Sens:Reslv.Guile.Notice."},
