    ...
    var
        ...
        values = {"Attribute":{"name":"Attribute","fieldName":"attribute","group":"Type","description":"","variable":"atr{0}{1}","title":"Attributes","subGroup":"","descriptions":[""],
            ...
            "Style_Arcanestrike Arte":{"name":"Style_Arcanestrike Arte","fieldName":"style_arcanestrike_arte","group":"Style","description":"","variable":"sty-arcanestrike_arte{0}","title":"Arcanestrike Arte","subGroup":"Skirmish Weapons","descriptions":["A Skirmish-focused style that surges energy into their attacks before striking."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","baseStyle":"","tier":null},
            "Style_Flame Spellblade Arte":{"name":"Style_Flame Spellblade Arte","fieldName":"style_flame_spellblade_arte","group":"Style","description":"","variable":"sty-flame_spellblade_arte{0}","title":"Flame Spellblade Arte","subGroup":"Skirmish Weapons","descriptions":["Fire. A Skirmish and Enchant-focused style that allows enchanting one's own attacks with fire before striking."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","baseStyle":"Arcanestrike Arte","tier":null},
            "Style_Lightning Spellblade Arte":{"name":"Style_Lightning Spellblade Arte","fieldName":"style_lightning_spellblade_arte","group":"Style","description":"","variable":"sty-lightning_spellblade_arte{0}","title":"Lightning Spellblade Arte","subGroup":"Skirmish Weapons","descriptions":["Metal. A Skirmish and Enchant-focused style that allows enchanting one's own attacks with lightning before striking."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","baseStyle":"Arcanestrike Arte","tier":null},
            "Style_Cold Spellblade Arte":{"name":"Style_Cold Spellblade Arte","fieldName":"style_cold_spellblade_arte","group":"Style","description":"","variable":"sty-cold_spellblade_arte{0}","title":"Cold Spellblade Arte","subGroup":"Skirmish Weapons","descriptions":["Water. A Skirmish and Enchant-focused style that allows enchanting one's own attacks with cold before striking."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","baseStyle":"Arcanestrike Arte","tier":null},
            ...
            "Style_Swashbuckling Arte":{"name":"Style_Swashbuckling Arte","fieldName":"style_swashbuckling_arte","group":"Style","description":"","variable":"sty-swashbuckling_arte{0}","title":"Swashbuckling Arte","subGroup":"Skirmish Weapons","descriptions":["A Skirmish-focused style that hinders their foes and uses clever footwork to disengage."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","baseStyle":"","tier":null},
            "Style_Deftblade Arte":{"name":"Style_Deftblade Arte","fieldName":"style_deftblade_arte","group":"Style","description":"","variable":"sty-deftblade_arte{0}","title":"Deftblade Arte","subGroup":"Skirmish Weapons","descriptions":["A Skirmish-focused style that uses evasive maneuvers to attack and defend. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[]
            ...
            "Style_Aerial Arte":{"name":"Style_Aerial Arte","fieldName":"style_aerial_arte","group":"Style","description":"","variable":"sty-aerial_arte{0}","title":"Aerial Arte","subGroup":"Martial Arts","descriptions":["A Grapping-focused style that relies on aerial attacks to defeat their enemies."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","baseStyle":"","tier":null},
            "Style_Windfall Arte":{"name":"Style_Windfall Arte","fieldName":"style_windfall_arte","group":"Style","description":"","variable":"sty-windfall_arte{0}","title":"Windfall Arte","subGroup":"Martial Arts","descriptions":["Wood. A Grappling and Enchant-focused style that allows one to perform acrobatic maneuvers that strike hard from above. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","baseStyle":"Aerial Arte","tier":null},
            "Style_Firefall Arte":{"name":"Style_Firefall Arte","fieldName":"style_firefall_arte","group":"Style","description":"","variable":"sty-firefall_arte{0}","title":"Firefall Arte","subGroup":"Martial Arts","descriptions":["Fire. A Grappling and Enchant-focused style that allows one to perform acrobatic maneuvers that strike hard from above. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","baseStyle":"Aerial Arte","tier":null},
            "Style_Skyfall Arte":{"name":"Style_Skyfall Arte","fieldName":"style_skyfall_arte","group":"Style","description":"","variable":"sty-skyfall_arte{0}","title":"Skyfall Arte","subGroup":"Martial Arts","descriptions":["Metal. A Grappling and Enchant-focused style that allows one to perform acrobatic maneuvers that strike hard from above. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","baseStyle":"Aerial Arte","tier":null},
            ...
            "Job_Geomancer":{"name":"Job_Geomancer","fieldName":"job_geomancer","group":"Job","description":"","variable":"job-geomancer{0}","title":"Geomancer","subGroup":"Athlete","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
            ...
            "JStyle_Kineticist":{"name":"JStyle_Kineticist","fieldName":"jstyle_kineticist","group":"JobStyle","description":"","variable":"jbs-kineticist{0}","title":"Kineticist","subGroup":"Athlete","descriptions":["The kineticist is a highly mobile caster that expertly throws objects and magic. By attacking, the kineticist stores excess ki into their body to release it into a burst of movement.\nWhen building a kineticist, try to focus on techniques that will allow them to attack from a short distance or benefit from movement. The kineticist lacks ways to protect themselves so any defensive techniques are likely to help a kineticist.\nKineticists tend to benefit from a high precision and quickness attribute. Kinesis is always helpful to train as it allows a Kineticist to make full use of their abilities."],
                ...
                "linkedGroups":[],
                "isResource":"","requirements":"None","defenses":"Defs:Reflx(+++).Evade. Sens:Guile(++)."},
            "JStyle_Geomancer":{"name":"JStyle_Geomancer","fieldName":"jstyle_geomancer","group":"JobStyle","description":"","variable":"jbs-geomancer{0}","title":"Geomancer","subGroup":"Athlete","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","requirements":"None","defenses":""},
