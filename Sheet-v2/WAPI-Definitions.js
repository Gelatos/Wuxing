    ...
    var
        ...
        values = {"Attribute":{"name":"Attribute","fieldName":"attribute","group":"Type","description":"","variable":"atr{0}{1}","title":"Attributes","subGroup":"","descriptions":[""],
            ...
            "Def_Fortitude":{"name":"Def_Fortitude","fieldName":"fortitude","group":"Defense","description":"","variable":"def-fortitude{0}","title":"Fortitude","subGroup":"Defense","descriptions":["Fortitude is your body's defense against afflictions that would attack you internally such as poisons or sickness. "],
                "abbreviation":"Fort","baseFormula":"","modifiers":"_expertise; _tech","formula":{"workers":[{"variableName":[],
                        "definitionName":[],
                        "value":7,"multiplier":1,"max":0},
                        {"variableName":["adv-cr"],
                            "definitionName":["CR"],
                        ...
                        {"variableName":["atr-bod"],
                            ...
                            "value":0,"multiplier":1,"max":0},
                        {"variableName":["def-fortitude_expertise"],
                            "definitionName":[],
                            "value":0,"multiplier":1,"max":0},
                        {"variableName":["def-fortitude_tech"],
                            "definitionName":[],
                            "value":0,"multiplier":1,"max":0}]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "Def_Hide":{"name":"Def_Hide","fieldName":"hide","group":"Defense","description":"","variable":"def-hide{0}","title":"Hide","subGroup":"Defense","descriptions":["Hide is your ability to stay quiet and out of sight while you have the hidden status. "],
                "abbreviation":"Hide","baseFormula":"","modifiers":"_expertise; _tech","formula":{"workers":[{"variableName":[],
                        "definitionName":[],
                        "value":7,"multiplier":1,"max":0},
                        {"variableName":["adv-cr"],
                            "definitionName":["CR"],
            ...
            "Def_Resolve":{"name":"Def_Resolve","fieldName":"resolve","group":"Sense","description":"","variable":"sen-resolve{0}","title":"Resolve","subGroup":"Social Sense","descriptions":["Resolve is the ability to persevere when your will is attacked. Your resolve will defend you from attacks against your Willpower and any other attempts that check against your convictions. "],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Def_Ego":{"name":"Def_Ego","fieldName":"ego","group":"Sense","description":"","variable":"sen-ego{0}","title":"Ego","subGroup":"Social Sense","descriptions":["Ego is the ability to persevere attacks to your self that aim to hurt your willpower. "],
            ...
            "Def_Guile":{"name":"Def_Guile","fieldName":"guile","group":"Sense","description":"","variable":"sen-guile{0}","title":"Guile","subGroup":"Social Sense","descriptions":["Guile is one's ability to conceal their own thoughts and feelings. It is the defense for those that do not wish to reveal their intentions or motivations. It is used to defend against those that wish to understand your influences or manipulate your feelings on them."],
                "abbreviation":"Guil","baseFormula":"","modifiers":"_expertise; _tech","formula":{"workers":[{"variableName":[],
                        "definitionName":[],
                        "value":7,"multiplier":1,"max":0},
                        {"variableName":["adv-cr"],
                            "definitionName":["CR"],
            ...
            "Soc_Impatience":{"name":"Soc_Impatience","fieldName":"impatience","group":"Social","description":"","variable":"soc-impatience{0}","title":"Impatience","subGroup":"","descriptions":["Impatience is a measure of how much a character will tolerate another's attempts at socializing before removing themselves."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Trait_AP":{"name":"Trait_AP","fieldName":"ap","group":"Trait","description":"","variable":"trt-ap{0}","title":"AP","subGroup":"Impact Trait","descriptions":["This damage pierces through armor. Ignore all armor on the target."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Arcing":{"name":"Trait_Arcing","fieldName":"arcing","group":"Trait","description":"","variable":"trt-arcing{0}","title":"Arcing","subGroup":"Impact Trait","descriptions":["Arcing techniques are designed to lob projectiles over obstacles. They can be used to target targets without line of sight, although they are still affected by cover and the attack must be physically possible - an Arcing attacks still can’t fire through 50 feet of metal."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Attack":{"name":"Trait_Attack","fieldName":"attack","group":"Trait","description":"","variable":"trt-attack{0}","title":"Attack","subGroup":"Impact Trait","descriptions":["This technique is designed to cause a harmful effect onto another character. Some effects require that an attack is being made in order to take effect."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "Trait_Brutal":{"name":"Trait_Brutal","fieldName":"brutal","group":"Trait","description":"","variable":"trt-brutal{0}","title":"Brutal","subGroup":"Impact Trait","descriptions":["When rolling dice for this effect, roll all dice twice and take only the highest results."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Brace":{"name":"Trait_Check-Brace","fieldName":"check-brace","group":"Trait","description":"","variable":"trt-check-brace{0}","title":"Check[Brace]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Brace defense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Fortitude":{"name":"Trait_Check-Fortitude","fieldName":"check-fortitude","group":"Trait","description":"","variable":"trt-check-fortitude{0}","title":"Check[Fortitude]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Fortitude defense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Warding":{"name":"Trait_Check-Warding","fieldName":"check-warding","group":"Trait","description":"","variable":"trt-check-warding{0}","title":"Check[Warding]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Warding defense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Hide":{"name":"Trait_Check-Hide","fieldName":"check-hide","group":"Trait","description":"","variable":"trt-check-hide{0}","title":"Check[Hide]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Hide defense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Reflex":{"name":"Trait_Check-Reflex","fieldName":"check-reflex","group":"Trait","description":"","variable":"trt-check-reflex{0}","title":"Check[Reflex]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Reflex defense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Evasion":{"name":"Trait_Check-Evasion","fieldName":"check-evasion","group":"Trait","description":"","variable":"trt-check-evasion{0}","title":"Check[Evasion]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Evasion defense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Resolve":{"name":"Trait_Check-Resolve","fieldName":"check-resolve","group":"Trait","description":"","variable":"trt-check-resolve{0}","title":"Check[Resolve]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Resolve sense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Insight":{"name":"Trait_Check-Insight","fieldName":"check-insight","group":"Trait","description":"","variable":"trt-check-insight{0}","title":"Check[Insight]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Insight sense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "Trait_Check-Guile":{"name":"Trait_Check-Guile","fieldName":"check-guile","group":"Trait","description":"","variable":"trt-check-guile{0}","title":"Check[Guile]","subGroup":"Impact Trait","descriptions":["This technique has you target a defense with a skill check.","This technique targets the Guile sense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "Trait_Holdfast":{"name":"Trait_Holdfast","fieldName":"holdfast","group":"Trait","description":"","variable":"trt-holdfast{0}","title":"Holdfast","subGroup":"Impact Trait","descriptions":["When this technique is used the resource costs are consumed immediately but all other effects are delayed. ","Once the next round starts, the technique may only be triggered after three turns have passed. All other effects of the technique can be performed on the user's turn as a Swift action. ","Only one Holdfast technique may be activated per turn."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Trait_Influence-Guile":{"name":"Trait_Influence-Guile","fieldName":"influence-guile","group":"Trait","description":"","variable":"trt-influence-guile{0}","title":"Influence[Guile]","subGroup":"Impact Trait","descriptions":["Influences are the the aspects of a character that connect them to the world. Influences can be leveraged to make an argument more likely to appeal to another character. ","This technique will modify the severity of an influence or reveal one.","This technique targets the Guile sense."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "Trait_Seeking":{"name":"Trait_Seeking","fieldName":"seeking","group":"Trait","description":"","variable":"trt-seeking{0}","title":"Seeking","subGroup":"Impact Trait","descriptions":["Seeking techniques completely ignore cover and line of sight, as long as it is physically possible to reach the target. Seeking techniques are usually self-guided, self- propelled, and able to navigate complex environments."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Trait_Willbreak":{"name":"Trait_Willbreak","fieldName":"willbreak","group":"Trait","description":"","variable":"trt-willbreak{0}","title":"Willbreak","subGroup":"Impact Trait","descriptions":["This technique attacks Willpower and may cause a Willbreak effect when Willpower is reduced to zero."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "TechName":{"name":"TechName","fieldName":"techname","group":"Untyped","description":"","variable":"techname{0}","title":"","subGroup":"","descriptions":[""],
                ...
                "linkedGroups":[],
                "isResource":""},
            "TechIsVisible":{"name":"TechIsVisible","fieldName":"techisvisible","group":"Untyped","description":"","variable":"techisvisible{0}","title":"","subGroup":"","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "TechAffinity":{"name":"TechAffinity","fieldName":"techaffinity","group":"Untyped","description":"","variable":"techaffinity{0}","title":"","subGroup":"","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "TechTier":{"name":"TechTier","fieldName":"techtier","group":"Untyped","description":"","variable":"techtier{0}","title":"","subGroup":"","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "TechTargetingData":{"name":"TechTargetingData","fieldName":"techtargetingdata","group":"Untyped","description":"","variable":"techtargetingdata{0}","title":"","subGroup":"","descriptions":[""],
                ...
                "linkedGroups":[],
                "isResource":""},
            "TechForm":{"name":"TechForm","fieldName":"techform","group":"Untyped","description":"","variable":"techform{0}","title":"","subGroup":"","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "TechTrait":{"name":"TechTrait","fieldName":"techtrait","group":"Untyped","description":"","variable":"techtrait{0}","title":"","subGroup":"","descriptions":[""],
                ...
                "linkedGroups":[],
                "isResource":""},
            "TechCoreDefense":{"name":"TechCoreDefense","fieldName":"techcoredefense","group":"Untyped","description":"","variable":"techcoredef{0}","title":"","subGroup":"","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "Obstruction":{"name":"Obstruction","fieldName":"obstruction","group":"Untyped","description":"","variable":"","title":"Obstruction","subGroup":"Movement","descriptions":["An obstruction is anything that blocks passage, preventing movement into its space entirely. Obstructions are typically environmental but other characters can also be obstructions. Characters are obstructed by any solid objects or characters that are the same Size as them or larger.","Characters can freely pass through spaces occupied by obstructions smaller than them, including other characters; however, they can’t end a movement in a space that is occupied by another character or object unless specified. This means that a Size 2 character, for example, could move through the space of a Size 1 character or object, but could not finish its move in the same space.","Allied characters never cause obstruction, but characters still can’t end moves in their space."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "FreeMove":{"name":"FreeMove","fieldName":"freemove","group":"Untyped","description":"","variable":"freemove","title":"Free Move","subGroup":"Movement","descriptions":["This is a normal move action however it does not force you to become Engaged until you finish moving and you may move through enemy spaces."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "Skill_Agility":{"name":"Skill_Agility","fieldName":"agility","group":"Skill","description":"","variable":"skl-agility{0}","title":"Agility","subGroup":"Quickness or Strength","descriptions":["Agility is an active skill used for feats of dexterity and reflex. This skill will most often find use whenever a technique requires swift or reflexive action such as quickly dodging an attack or keeping your balance."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Alchemy":{"name":"Skill_Alchemy","fieldName":"alchemy","group":"Skill","description":"","variable":"skl-alchemy{0}","title":"Alchemy","subGroup":"Precision or Reason","descriptions":["Alchemy is a technical skill used when making alchemical creations. These creations typically take the form of medicines, poisons, salves, oils, and other consumable crafts."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Analyze":{"name":"Skill_Analyze","fieldName":"analyze","group":"Skill","description":"","variable":"skl-analyze{0}","title":"Analyze","subGroup":"Reason","descriptions":["Analyze is a technical skill used when information must be parsed quickly and efficiently. This skill is often used to find hidden clues that would not be in plain sight. It is also used whenever one wishes to quickly learn about a subject written in text or requires one to reason through a problem. "],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Build":{"name":"Skill_Build","fieldName":"build","group":"Skill","description":"","variable":"skl-build{0}","title":"Build","subGroup":"Strength or Reason","descriptions":["Build is an active skill used whenever you are creating an object through precise technique. This skill is used mostly when you wish to create through the use of tools but some complicated items will require build to represent the precision required in the object being created."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Channel":{"name":"Skill_Channel","fieldName":"channel","group":"Skill","description":"","variable":"skl-channel{0}","title":"Channel","subGroup":"Body or Essence","descriptions":["Channel is an active skill for maintaining concentration on energy ether and manipulating it. This skill will often be a base for magical effects that linger but are impermanent such as lingering flames, winds, or other elements."],
            ...
            "Skill_Conjure":{"name":"Skill_Conjure","fieldName":"conjure","group":"Skill","description":"","variable":"skl-conjure{0}","title":"Conjure","subGroup":"Body or Essence","descriptions":["Conjure is an active skill used to add form to ether by manipulating it into solid material. Many magical techniques spontaneously give form to ether - this skill is for when the ether is made solid and in large amounts."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Cook":{"name":"Skill_Cook","fieldName":"cook","group":"Skill","description":"","variable":"skl-cook{0}","title":"Cook","subGroup":"Quickness or Intuition ","descriptions":["Cook is a technical skill used when dealing with ingredients to be used for consumption and nutrition. This skill is not only used for traditional cooking but anytime food is prepared such as creating beverages. Food is an important resource to survive and keep spirits high. "],
            ...
            "Skill_Glyphwork":{"name":"Skill_Glyphwork","fieldName":"glyphwork","group":"Skill","description":"","variable":"skl-glyphwork{0}","title":"Glyphwork","subGroup":"Quickness","descriptions":["Glyphwork is a technical skill that allows one to create and manipulate pnevmarite technology. If a device requires magical tooling, this skill will often be used to work with it. "],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Grappling":{"name":"Skill_Grappling","fieldName":"grappling","group":"Skill","description":"","variable":"skl-grappling{0}","title":"Grappling","subGroup":"Body or Quickness","descriptions":["Grappling is an active skill that represents attacking with one's own body. Wrestling and forcing movement are always grapple skill checks. In addition, many strikes from fists or kicks are often grappling checks."],
            ...
            "Skill_Inspire":{"name":"Skill_Inspire","fieldName":"inspire","group":"Skill","description":"","variable":"skl-inspire{0}","title":"Inspire","subGroup":"Conviction","descriptions":["Inspire is a social skill used to evoke feelings of hope and to counter dispair. Inspire is used when motivating action. Techniques that use inspire often provide emotional boosts and bolster willpower. Inspire is also often used in persuasion attempts to convince another to help. "],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Kinesis":{"name":"Skill_Kinesis","fieldName":"kinesis","group":"Skill","description":"","variable":"skl-kinesis{0}","title":"Kinesis","subGroup":"Precision or Conviction","descriptions":["Kinesis is an active skill to manipulate ether that creates forces and maintaining it. Usually this is used for techniques that require precise movement of objects or areas."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Might":{"name":"Skill_Might","fieldName":"might","group":"Skill","description":"","variable":"skl-might{0}","title":"Might","subGroup":"Strength","descriptions":["Might is an active skill about using strength to beat a foe down. This skill is frequently used in weapon techniques with a focus on heavy swings and feats of power."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[{"variableName":["atr-str",""],
                        "definitionName":["Attr_STR",""],
                        "value":0,"multiplier":1,"max":0},
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Misdirect":{"name":"Skill_Misdirect","fieldName":"misdirect","group":"Skill","description":"","variable":"skl-misdirect{0}","title":"Misdirect","subGroup":"Conviction or Reason","descriptions":["Misdirect is a social skill used to obscure information through lies or omitting facts. Misdirect is most often applicable when using outright lies or tactics that try to redirect a conversation or one's attention."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[{"variableName":["atr-cnv","atr-rsn"],
                        "definitionName":["Attr_CNV","Attr_RSN"],
                        "value":0,"multiplier":1,"max":0},
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Physique":{"name":"Skill_Physique","fieldName":"physique","group":"Skill","description":"","variable":"skl-physique{0}","title":"Physique","subGroup":"Body","descriptions":["Physique is an active skill used when strength is required to perform. This skill comes into play when a technique requires raw power such as shoving, jumping, climbing, or lifting."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Pilot":{"name":"Skill_Pilot","fieldName":"pilot","group":"Skill","description":"","variable":"skl-pilot{0}","title":"Pilot","subGroup":"Precision or Conviction","descriptions":["Pilot is an active skill used to maneuver vehicles and machinery. Most complicated machinery will require a pilot check to utilize the device any many techniques with pilot allow you to perform complicated maneuvers with pilot."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[{"variableName":["atr-prc","atr-cnv"],
                        "definitionName":["Attr_PRC","Attr_CNV"],
                        "value":0,"multiplier":1,"max":0},
            ...
            "Skill_Rationalize":{"name":"Skill_Rationalize","fieldName":"rationalize","group":"Skill","description":"","variable":"skl-rationalize{0}","title":"Rationalize","subGroup":"Intuition or Reason","descriptions":["Rationalize is a social skill used when persuading another through reason and logic. Rationalize is usually a tool for negotiation when appealing to a logical mindset such as when pragmatism is necessary. It can also be used to deceive using misinformation and selling it as truth."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Search":{"name":"Skill_Search","fieldName":"search","group":"Skill","description":"","variable":"skl-search{0}","title":"Search","subGroup":"Intuition or Reason","descriptions":["Search is a technical skill used to find the hidden and anything that can be found with one's senses. Usually this is used to find characters hiding but can also be used to find hidden objects."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[{"variableName":["atr-int","atr-rsn"],
                        "definitionName":["Attr_INT","Attr_RSN"],
                        "value":0,"multiplier":1,"max":0},
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Shape":{"name":"Skill_Shape","fieldName":"shape","group":"Skill","description":"","variable":"skl-shape{0}","title":"Shape","subGroup":"Essence or Reason","descriptions":["Shape is an active skill used to transmute material into new objects and items through magic. Many building techniques require one to use shape to manipulate a material to accurately represent the intended form and ensure its durability."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Shoot":{"name":"Skill_Shoot","fieldName":"shoot","group":"Skill","description":"","variable":"skl-shoot{0}","title":"Shoot","subGroup":"Precision","descriptions":["Shoot is an active skill focused on aiming at targets at a distance. It's commonly used with ranged weapon techniques and ranged spells. "],
            ...
            "Skill_Skirmish":{"name":"Skill_Skirmish","fieldName":"skirmish","group":"Skill","description":"","variable":"skl-skirmish{0}","title":"Skirmish","subGroup":"Precision or Strength","descriptions":["Skirmish is an active skill for striking characters with melee attacks. It is exclusively an attacking skill for techniques that benefit from precise strikes to maximize effectiveness. "],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Sneak":{"name":"Skill_Sneak","fieldName":"sneak","group":"Skill","description":"","variable":"skl-sneak{0}","title":"Sneak","subGroup":"Body or Precision","descriptions":["Sneak is an active skill to conceal your presence. This will often be used to keep yourself hidden while performing other actions such as quick movement or stealthy attacks."],
            ...
            "Skill_Throw":{"name":"Skill_Throw","fieldName":"throw","group":"Skill","description":"","variable":"skl-throw{0}","title":"Throw","subGroup":"Precision or Strength","descriptions":["Throw is an active skill that allows one to throw objects accurately and far. This can be used to throw objects but also whenever a spell requires one to toss or lob an effect."],
                ...
                "linkedGroups":[],
                "isResource":""},
            "Skill_Tinker":{"name":"Skill_Tinker","fieldName":"tinker","group":"Skill","description":"","variable":"skl-tinker{0}","title":"Tinker","subGroup":"Precision or Quickness","descriptions":["Tinker is a technical skill that allows one to create and manipulate machinery and technology. This skill can be used to disarm traps and locks. Otherwise, this will also be used when constructing complicated technology that require gears, pulleys, or other devices that require moving parts."],
