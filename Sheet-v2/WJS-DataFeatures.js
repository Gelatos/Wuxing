...
function GetClassesList(isFields) {
	if (isFields) {
		return ["fighter", "interceptor", "marksman", "guardian", "rogue", "pugilist", "physician", "scholar"];
	}
	else {
		return ["Fighter", "Interceptor", "Marksman", "Guardian", "Rogue", "Pugilist", "Physician", "Scholar"];
	}
...
function GetMartialSkillTechniquesList(isFields) {
	if (isFields) {
		return ["brawler", "crushingBlade", "staggeringBlade", "piledriver", "shreddingDriver", "pointBlankShot", "shotOnTheRun", "poleVault", "quickDraw", "rapidVolley", "rushingVolley", "uppercut", "followUpLauncher"];
	}
	else {
		return ["Brawler", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Pole Vault", "Quick Draw", "Rapid Volley", "Rushing Volley", "Uppercut", "Follow Up Launcher"];
	}
}
...
function GetAllSkillTechniquesList(isFields) {
	if (isFields) {
		...
		return ["HP Up", "Improved Initiative", "Brawler", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Pole Vault", "Quick Draw", "Rapid Volley", "Rushing Volley", "Uppercut", "Follow Up Launcher", "Learn Spell", "Acceleration", "Power Vault", "Expeditious", "Quick Climb", "Quick Swim", "Poise", "Cat Fall", "Kip Up", "Silent Stride", "Armored Stealth", "Shove", "Knockdown", "Tumble", "Broad Study", "Experienced Tracker", "Multilingual", "Specialized Knowledge", "Create Diversion", "Demoralize", "Fascinate", "Impersonator", "First Aid"];
	}
}
...
function GetTechniquesInfo(name) {
	switch (name.toLowerCase()) {
		...
		case "skulk away":
			return { "name": "Skulk Away", "augmentBase": "", "techniqueGroup": "Class", "techniqueSubGroup": "Rogue", "techniqueType": "Passive", "action": "None", "traits": "", "limits": "", "resourceCost": "", "description": "You may move half your speed after performing a Follow-Up Attack.", "onSuccess": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "target": "", "targetCode": "", "onHit": "", "damage": "", "damageType": "", "element": "", "specBonus": "", "augments": ["Skulk Then Hide"] }
		case "skulk then hide":
			return { "name": "Skulk Then Hide", "augmentBase": "Skulk Away", "techniqueGroup": "Class", "techniqueSubGroup": "Rogue", "techniqueType": "Passive", "action": "None", "traits": "", "limits": "", "resourceCost": "", "description": "You may Hide after performing Skulk Away.", "onSuccess": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "target": "", "targetCode": "", "onHit": "", "damage": "", "damageType": "", "element": "", "specBonus": "", "augments": [] }
		case "emergency care":
