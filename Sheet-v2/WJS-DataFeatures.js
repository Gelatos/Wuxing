...
function GetInterceptorTechniquesList(isFields) {
	if (isFields) {
		return ["preemptiveStrike", "preemptiveStagger", "criticalMaim", "lunge", "stepForward"];
	}
	else {
		return ["Preemptive Strike", "Preemptive Stagger", "Critical Maim", "Lunge", "Step Forward"];
	}
}
...
function GetAllClassTechniquesList(isFields) {
	if (isFields) {
		return ["secondWind", "shrugItOff", "undaunted", "alwaysArmored", "blockingExpert", "preemptiveStrike", "preemptiveStagger", "criticalMaim", "lunge", "stepForward", "spellshot", "distantSpell", "savior", "spellstrike", "powerSkirmish", "sneakAttack", "sneakyFollow-Up", "assassinate", "skulkAway", "thenHide", "emergencyCare", "nightingale", "rhapsody", "firstAid", "cleansingAid", "flurryOfBlows", "throwDown", "stunningStrike", "sprint", "run", "metamagic", "strategize", "environmentalAwareness", "foresight", "sawThatComing", "asYouMayRecall", "eclecticKnowledge", "pointOfClarity"];
	}
	else {
		return ["Second Wind", "Shrug It Off", "Undaunted", "Always Armored", "Blocking Expert", "Preemptive Strike", "Preemptive Stagger", "Critical Maim", "Lunge", "Step Forward", "Spellshot", "Distant Spell", "Savior", "Spellstrike", "Power Skirmish", "Sneak Attack", "Sneaky Follow-Up", "Assassinate", "Skulk Away", "Then Hide", "Emergency Care", "Nightingale", "Rhapsody", "First Aid", "Cleansing Aid", "Flurry of Blows", "Throw Down", "Stunning Strike", "Sprint", "Run", "Metamagic", "Strategize", "Environmental Awareness", "Foresight", "Saw That Coming", "As You May Recall", "Eclectic Knowledge", "Point of Clarity"];
	}
}
...
function GetMartialSkillTechniquesList(isFields) {
	if (isFields) {
		return ["advancedMartialSkill", "brawler", "crushingBlade", "staggeringBlade", "piledriver", "shreddingDriver", "pointBlankShot", "shotOnTheRun", "quickDraw", "rapidVolley", "rushingVolley", "sharpshooter", "deadeye", "uppercut", "followUpLauncher"];
	}
	else {
		return ["Advanced Martial Skill", "Brawler", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Quick Draw", "Rapid Volley", "Rushing Volley", "Sharpshooter", "Deadeye", "Uppercut", "Follow Up Launcher"];
	}
}
...
function GetBodySkillTechniquesList(isFields) {
	if (isFields) {
		return ["advancedActiveSkill", "acceleration", "powerVault", "expeditious", "quickClimb", "quickSwim", "poise", "catFall", "kipUp", "silentStride", "armoredStealth", "shove", "knockdown", "tumble"];
	}
	else {
		return ["Advanced Active Skill", "Acceleration", "Power Vault", "Expeditious", "Quick Climb", "Quick Swim", "Poise", "Cat Fall", "Kip Up", "Silent Stride", "Armored Stealth", "Shove", "Knockdown", "Tumble"];
	}
}
...
function GetAllSkillTechniquesList(isFields) {
	if (isFields) {
		return ["advancedDefensiveSkill", "hPUp", "improvedInitiative", "advancedMartialSkill", "brawler", "crushingBlade", "staggeringBlade", "piledriver", "shreddingDriver", "pointBlankShot", "shotOnTheRun", "quickDraw", "rapidVolley", "rushingVolley", "sharpshooter", "deadeye", "uppercut", "followUpLauncher", "advancedMagicSkill", "learnSpell", "advancedActiveSkill", "acceleration", "powerVault", "expeditious", "quickClimb", "quickSwim", "poise", "catFall", "kipUp", "silentStride", "armoredStealth", "shove", "knockdown", "tumble", "advancedKnowledgeSkill", "broadStudy", "experiencedTracker", "multilingual", "specializedKnowledge", "advancedSocialSkill", "createDiversion", "demoralize", "fascinate", "impersonator", "advancedTechnicalSkill", "firstAid"];
	}
	else {
		return ["Advanced Defensive Skill", "HP Up", "Improved Initiative", "Advanced Martial Skill", "Brawler", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Quick Draw", "Rapid Volley", "Rushing Volley", "Sharpshooter", "Deadeye", "Uppercut", "Follow Up Launcher", "Advanced Magic Skill", "Learn Spell", "Advanced Active Skill", "Acceleration", "Power Vault", "Expeditious", "Quick Climb", "Quick Swim", "Poise", "Cat Fall", "Kip Up", "Silent Stride", "Armored Stealth", "Shove", "Knockdown", "Tumble", "Advanced Knowledge Skill", "Broad Study", "Experienced Tracker", "Multilingual", "Specialized Knowledge", "Advanced Social Skill", "Create Diversion", "Demoralize", "Fascinate", "Impersonator", "Advanced Technical Skill", "First Aid"];
	}
}
...
function GetTechniquesInfo(name) {
	switch (name.toLowerCase()) {
		...
		case "ether sense":
			return { "name": "Ether Sense", "augmentBase": "", "techniqueGroup": "Metal", "techniqueSubGroup": "Basic", "techniqueType": "Passive", "action": "", "traits": "", "limits": "", "resourceCost": "", "description": "When you are within 1 space of a source of stable ether you are made aware of what object is causing the ether.", "onSuccess": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "target": "", "targetCode": "", "onHit": "", "damage": "", "damageType": "", "element": "", "specBonus": "", "augments": ["Spirit Sense"] }
		case "spirit sense":
