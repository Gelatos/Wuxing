...
function GetTechniquesInfo(name) {
	switch (name.toLowerCase()) {
		case "defensive training":
			return { "name": "Defensive Training", "augmentBase": "", "techniqueGroup": "Training Path", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "None", "traits": "", "limits": "", "resourceCost": "", "description": "Become trained in one Defensive skill.", "onSuccess": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "target": "", "targetCode": "", "onHit": "", "damage": "", "damageType": "", "element": "", "specBonus": "", "augments": ["Defensive Training +", "Defensive Training ++"] }
		case "defensive training +":
			return { "name": "Defensive Training +", "augmentBase": "Defensive Training", "techniqueGroup": "Training Path", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "None", "traits": "", "limits": "", "resourceCost": "", "description": "Become trained in one Defensive skill.", "onSuccess": "", "trigger": "", "requirement": "", "prerequisite": "Character Level 18", "skill": "", "defense": "", "range": "", "target": "", "targetCode": "", "onHit": "", "damage": "", "damageType": "", "element": "", "specBonus": "", "augments": [] }
		case "defensive training ++":
		...
		case "advanced active skill":
			return { "name": "Advanced Active Skill", "augmentBase": "", "techniqueGroup": "Body Skill", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "Multiple", "limits": "", "resourceCost": "", "description": "Choose a Body Skill. You gain a +2 bonus to the selected skill. This technique can be taken multiple times, each time it applies to a different skill.", "onSuccess": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "target": "", "targetCode": "", "onHit": "", "damage": "", "damageType": "", "element": "", "specBonus": "", "augments": [] }
		case "acceleration":
