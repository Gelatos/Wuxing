...
function GetClassesList(isFields) {
	if (isFields) {
		return ["fighter", "interceptor", "marksman", "guardian", "athlete", "rogue", "physician", "scholar"];
	}
	else {
		return ["Fighter", "Interceptor", "Marksman", "Guardian", "Athlete", "Rogue", "Physician", "Scholar"];
	}
...
function GetGeneralPathTechniquesList(isFields) {
	if (isFields) {
		return ["extraFollow-UpAttack", "doubleFollow-UpAttack", "refocus", "refocus+", "sustainedChannel", "sustainedChannel+", "affinity", "affinity+", "branchingOut", "branchingOut+", "chakraControl", "chakraControl+", "chakraControl++", "stressRelease", "stressRelease+", "stressRelease++", "undying", "undying+", "vitalityBoost", "vitalityBoost+", "vitalityBoost++"];
	}
	else {
		return ["Extra Follow-Up Attack", "Double Follow-Up Attack", "Refocus", "Refocus +", "Sustained Channel", "Sustained Channel +", "Affinity", "Affinity +", "Branching Out", "Branching Out +", "Chakra Control", "Chakra Control +", "Chakra Control ++", "Stress Release", "Stress Release +", "Stress Release ++", "Undying", "Undying +", "Vitality Boost", "Vitality Boost +", "Vitality Boost ++"];
	}
}

function GetAllPathTechniquesList(isFields) {
	if (isFields) {
		return ["phys.DefensiveTraining", "phys.DefensiveTraining+", "sens.DefenseTraining", "sens.DefenseTraining+", "combatTraining", "combatTraining+", "combatTraining++", "magicTraining", "magicTraining+", "magicTraining++", "bodyTraining", "bodyTraining+", "bodyTraining++", "knowledgeTraining", "knowledgeTraining+", "knowledgeTraining++", "socialTraining", "socialTraining+", "socialTraining++", "technicalTraining", "technicalTraining+", "technicalTraining++", "extraFollow-UpAttack", "doubleFollow-UpAttack", "refocus", "refocus+", "sustainedChannel", "sustainedChannel+", "affinity", "affinity+", "branchingOut", "branchingOut+", "chakraControl", "chakraControl+", "chakraControl++", "stressRelease", "stressRelease+", "stressRelease++", "undying", "undying+", "vitalityBoost", "vitalityBoost+", "vitalityBoost++"];
	}
	else {
		return ["Phys. Defensive Training", "Phys. Defensive Training +", "Sens. Defense Training", "Sens. Defense Training +", "Combat Training", "Combat Training +", "Combat Training ++", "Magic Training", "Magic Training +", "Magic Training ++", "Body Training", "Body Training +", "Body Training ++", "Knowledge Training", "Knowledge Training +", "Knowledge Training ++", "Social Training", "Social Training +", "Social Training ++", "Technical Training", "Technical Training +", "Technical Training ++", "Extra Follow-Up Attack", "Double Follow-Up Attack", "Refocus", "Refocus +", "Sustained Channel", "Sustained Channel +", "Affinity", "Affinity +", "Branching Out", "Branching Out +", "Chakra Control", "Chakra Control +", "Chakra Control ++", "Stress Release", "Stress Release +", "Stress Release ++", "Undying", "Undying +", "Vitality Boost", "Vitality Boost +", "Vitality Boost ++"];
	}
}

function GetWarfareTechniquesList(isFields) {
	if (isFields) {
		return ["hPUp", "kiStrike", "dropKick", "uppercut", "follow-UpGrapple", "crushingBlade", "staggeringBlade", "piledriver", "shreddingDriver", "pointBlankShot", "shotOnTheRun", "poleVault", "quickDraw", "rapidVolley", "rushingVolley"];
	}
	else {
		return ["HP Up", "Ki Strike", "Drop Kick", "Uppercut", "Follow-Up Grapple", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Pole Vault", "Quick Draw", "Rapid Volley", "Rushing Volley"];
	}
}

function GetTalentTechniquesList(isFields) {
	if (isFields) {
		return ["acceleration", "powerVault", "expeditious", "quickClimb", "quickSwim", "poise", "catFall", "kipUp", "silentStride", "shove", "knockdown", "tumble", "fieldMedic"];
	}
	else {
		return ["Acceleration", "Power Vault", "Expeditious", "Quick Climb", "Quick Swim", "Poise", "Cat Fall", "Kip Up", "Silent Stride", "Shove", "Knockdown", "Tumble", "Field Medic"];
	}
}

function GetAcumenTechniquesList(isFields) {
	if (isFields) {
		return ["broadStudy", "experiencedTracker", "multilingual", "specializedKnowledge", "improvedInitiative", "createDiversion", "demoralize", "fascinate", "impersonator"];
	}
	else {
		return ["Broad Study", "Experienced Tracker", "Multilingual", "Specialized Knowledge", "Improved Initiative", "Create Diversion", "Demoralize", "Fascinate", "Impersonator"];
	}
}

function GetAllSkillTechniquesList(isFields) {
	if (isFields) {
		return ["hPUp", "kiStrike", "dropKick", "uppercut", "follow-UpGrapple", "crushingBlade", "staggeringBlade", "piledriver", "shreddingDriver", "pointBlankShot", "shotOnTheRun", "poleVault", "quickDraw", "rapidVolley", "rushingVolley", "acceleration", "powerVault", "expeditious", "quickClimb", "quickSwim", "poise", "catFall", "kipUp", "silentStride", "shove", "knockdown", "tumble", "fieldMedic", "broadStudy", "experiencedTracker", "multilingual", "specializedKnowledge", "improvedInitiative", "createDiversion", "demoralize", "fascinate", "impersonator"];
	}
	else {
		return ["HP Up", "Ki Strike", "Drop Kick", "Uppercut", "Follow-Up Grapple", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Pole Vault", "Quick Draw", "Rapid Volley", "Rushing Volley", "Acceleration", "Power Vault", "Expeditious", "Quick Climb", "Quick Swim", "Poise", "Cat Fall", "Kip Up", "Silent Stride", "Shove", "Knockdown", "Tumble", "Field Medic", "Broad Study", "Experienced Tracker", "Multilingual", "Specialized Knowledge", "Improved Initiative", "Create Diversion", "Demoralize", "Fascinate", "Impersonator"];
	}
}
...
function GetTechniquesInfo(name) {
	switch (name.toLowerCase()) {
		...
		case "extra follow-up attack":
			return { "name": "Extra Follow-Up Attack", "augmentBase": "", "techniqueGroup": "General Path", "techniqueSubGroup": "", "techniqueType": "Standard", "action": "Reaction ", "traits": "Armament", "limits": "1/Round", "resourceCost": "", "description": "You perform a melee attack against your ally's target.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "An ally makes a melee or ranged attack against a character and you are engaged with the character.", "requirement": "", "prerequisite": "Character Level 4", "skill": "Weapon", "defense": "BR DC", "range": "Weapon", "rType": "Threat", "target": "One target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "double follow-up attack":
			return { "name": "Double Follow-Up Attack", "augmentBase": "", "techniqueGroup": "General Path", "techniqueSubGroup": "", "techniqueType": "Standard", "action": "Reaction ", "traits": "Armament", "limits": "2/Round", "resourceCost": "", "description": "You perform a melee attack against your ally's target.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "An ally makes a melee or ranged attack against a character and you are engaged with the character.", "requirement": "", "prerequisite": "Character Level 24", "skill": "Weapon", "defense": "BR DC", "range": "Weapon", "rType": "Threat", "target": "One target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "refocus":
			return { "name": "Refocus", "augmentBase": "", "techniqueGroup": "General Path", "techniqueSubGroup": "", "techniqueType": "Standard", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "You quickly recenter. You may exchange one loaded tech slot with another technique.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Character level 4", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Refocus +"] }
		case "refocus +":
			return { "name": "Refocus +", "augmentBase": "Refocus", "techniqueGroup": "General Path", "techniqueSubGroup": "", "techniqueType": "Standard", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "You may exchange two loaded tech slots with two other techniques.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Character Level 34", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		...
		case "hp up":
			return { "name": "HP Up", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "Gain a bonus to HP equal to half your character level. Whenever you gain an even numbered character level you also gain 1 HP.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "ki strike":
			return { "name": "Ki Strike", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "You wrap your body with ki and strike. ", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "Must be channeling ki", "prerequisite": "", "skill": "Brawling", "defense": "BR DC", "range": "1", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "2", "dType": "3", "dBonus": "Power", "damageType": "Force", "element": "", "augments": ["Drop Kick", "Uppercut", "Follow-Up Grapple"] }
		case "drop kick":
			return { "name": "Drop Kick", "augmentBase": "Ki Strike", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Quick", "traits": "", "limits": "", "resourceCost": "1 Mana", "description": "", "onSuccess": "The target gains the Prone status.", "dConditions": "C:Prone", "tEffect": "C:Prone", "rEffect": "", "trigger": "", "requirement": "The target must be Launched and you must be 1 space above the target.", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "2", "dType": "6", "dBonus": "Power", "damageType": "Force", "element": "", "augments": [] }
		case "uppercut":
			return { "name": "Uppercut", "augmentBase": "Ki Strike", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Quick", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "", "onSuccess": "The target gains the Launched status.", "dConditions": "C:Launched", "tEffect": "C:Launched", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "3", "dType": "3", "dBonus": "Power", "damageType": "Force", "element": "", "augments": [] }
		case "follow-up grapple":
			return { "name": "Follow-Up Grapple", "augmentBase": "Ki Strike", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Reaction", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "You attempt to grapple your ally's target.", "onSuccess": "Both you and the target gain the grappled status.", "dConditions": "S:Grappled", "tEffect": "S:Grappled;S*:Grappled", "rEffect": "", "trigger": "An ally makes a melee or ranged attack against a character and you are engaged with the character.", "requirement": "", "prerequisite": "", "skill": "Physique", "defense": "BR DC", "range": "1", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "0", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "crushing blade":
			return { "name": "Crushing Blade", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Full", "traits": "Armament [F]", "limits": "", "resourceCost": "", "description": "You attempt to power through any defense the foe has. Make a melee attack.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "Must be attacking with a Might weapon", "prerequisite": "Trained in Might", "skill": "Weapon", "defense": "Reflex DC", "range": "Weapon", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Staggering Blade"] }
		case "staggering blade":
			return { "name": "Staggering Blade", "augmentBase": "Crushing Blade", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Full", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "", "onSuccess": "The target gains the Staggered condition.", "dConditions": "C:Staggered", "tEffect": "C:Staggered", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "piledriver":
			return { "name": "Piledriver", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Full", "traits": "Armament [F]; Brutal", "limits": "", "resourceCost": "2 Mana", "description": "You swing with incredible force at your target, attempting to launch them into the air. Make a melee attack. ", "onSuccess": "The target gains the Launched status.", "dConditions": "C:Launched", "tEffect": "C:Launched", "rEffect": "", "trigger": "", "requirement": "Must be attacking with a Might weapon", "prerequisite": "Trained in Might", "skill": "Weapon", "defense": "BR DC", "range": "Weapon", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Shredding Driver"] }
		case "shredding driver":
			return { "name": "Shredding Driver", "augmentBase": "Piledriver", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Full", "traits": "AP (4); Armament [F]; Brutal", "limits": "", "resourceCost": "3 Mana", "description": "", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "point blank shot":
			return { "name": "Point Blank Shot", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Swift", "traits": "", "limits": "", "resourceCost": "", "description": "You are treated as having threat 2 when equipped with a Bow or Handgun weapon.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Marksmanship", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Shot on the Run"] }
		case "shot on the run":
			return { "name": "Shot on the Run", "augmentBase": "Point Blank Shot", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Swift", "traits": "", "limits": "", "resourceCost": "", "description": "When you use a Bow or Handgun weapon as a melee weapon, you may immediately move 1 space.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "pole vault":
			return { "name": "Pole Vault", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Reaction", "traits": "", "limits": "", "resourceCost": "", "description": "You increase your jump height by 2 on both horizontal and vertical jumps.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "You jump during your movement.", "requirement": "You are wielding a Polearm weapon.", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "quick draw":
			return { "name": "Quick Draw", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Swift", "traits": "", "limits": "", "resourceCost": "", "description": "You may ignore the 1 / Turn limit of the Equip action when equipping a weapon that does not have the Two-handed trait.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "rapid volley":
			return { "name": "Rapid Volley", "augmentBase": "", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Full", "traits": "Armament; Brutal", "limits": "", "resourceCost": "", "description": "You strike fast to catch an evasive target. Make a melee attack.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "Must be attacking with a Polearm weapon", "prerequisite": "Trained in Polearm", "skill": "Weapon", "defense": "Brace DC", "range": "Weapon", "rType": "Threat", "target": "One target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Rushing Volley"] }
		case "rushing volley":
			return { "name": "Rushing Volley", "augmentBase": "Rapid Volley", "techniqueGroup": "Warfare", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Full", "traits": "Armament [F]; Brutal", "limits": "", "resourceCost": "2 Mana", "description": "", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "acceleration":
			return { "name": "Acceleration", "augmentBase": "", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Support", "action": "Quick", "traits": "", "limits": "1/Round", "resourceCost": "1 Mana", "description": "Until the end of your turn, your speed increases by 2. You may then move up to half your speed.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Athletics", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Power Vault"] }
		case "power vault":
			return { "name": "Power Vault", "augmentBase": "Acceleration", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Support", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "Until the end of your turn, your horizontal and vertical jump distance is doubled.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "expeditious":
			return { "name": "Expeditious", "augmentBase": "", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "Your speed increases by 1.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Athletics", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Quick Climb", "Quick Swim"] }
		case "quick climb":
			return { "name": "Quick Climb", "augmentBase": "Expeditious", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "When you climb you move at half your full speed.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "quick swim":
			return { "name": "Quick Swim", "augmentBase": "Expeditious", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "When you swim you move at your full speed.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "poise":
			return { "name": "Poise", "augmentBase": "", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "You always succeed at normal difficulty Acrobatics checks to maintain balance.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Acrobatics", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Cat Fall", "Kip Up"] }
		case "cat fall":
			return { "name": "Cat Fall", "augmentBase": "Poise", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "Treat falls as 4 spaces shorter.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "kip up":
			return { "name": "Kip Up", "augmentBase": "Poise", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "On your turn, you can get up from prone for free.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "silent stride":
			return { "name": "Silent Stride", "augmentBase": "", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "If you are hidden and lose cover, you may use your standard move and not lose the hidden status as long as your move ends with you in cover.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Stealth", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "shove":
			return { "name": "Shove", "augmentBase": "", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "You try to ram into a character.", "onSuccess": "You may choose to push the target up to two spaces, directly away from you. If you move the target, you may follow the target up to the same distance you moved them.", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "Target must be the same Size or smaller than you.", "prerequisite": "Trained in Physique", "skill": "Physique", "defense": "BR DC", "range": "1", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Knockdown"] }
		case "knockdown":
			return { "name": "Knockdown", "augmentBase": "Shove", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Active", "action": "Quick", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "", "onSuccess": "Your target is also knocked prone. ", "dConditions": "C:Prone", "tEffect": "C:Prone", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "tumble":
			return { "name": "Tumble", "augmentBase": "", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Support", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "You move at least 1 space, up to your speed. During this movement, you can try to move through the space of one enemy. Attempt an Acrobatics check against the enemy’s Reflex DC as soon as you try to enter its space. ", "onSuccess": "You do not trigger engagement and may continue moving.", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Acrobatics", "skill": "Acrobatics", "defense": "Reflex DC", "range": "1", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "field medic":
			return { "name": "Field Medic", "augmentBase": "", "techniqueGroup": "Talent", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "When treating wounds during a long rest, unless the wound has unique end conditions, you always succeed at your Medicine check.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Medicine", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "broad study":
			return { "name": "Broad Study", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "You are well read in a lot of different subjects. Gain a +1 bonus whenever making a Recall Knowledge check.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "experienced tracker":
			return { "name": "Experienced Tracker", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "You track at your full speed.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Survival", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "multilingual":
			return { "name": "Multilingual", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "Multiple", "limits": "", "resourceCost": "", "description": "You gain three Languages.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "specialized knowledge":
			return { "name": "Specialized Knowledge", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "Multiple", "limits": "", "resourceCost": "", "description": "You gain three Lore Knowledges.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "improved initiative":
			return { "name": "Improved Initiative", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "Your initiative increases by 4.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "create diversion":
			return { "name": "Create Diversion", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Support", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "With a gesture, a trick, or some distracting words, you can create a diversion that draws creatures' attention elsewhere. ", "onSuccess": "Until the end of this turn, you have +1 advantage on the next attack roll against the target.", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Deception", "skill": "Deception", "defense": "Insight DC", "range": "3", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "demoralize":
			return { "name": "Demoralize", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Support", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "With a sudden shout, a well-timed taunt, or a cutting putdown, you can shake an enemy's resolve. \n\nRegardless of your result, the target is temporarily immune to your attempts to Demoralize it for 5 minutes.", "onSuccess": "The target gains the frightened condition.", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Intimidation", "skill": "Intimidation", "defense": "Resolve DC", "range": "5", "rType": "Threat", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "fascinate":
			return { "name": "Fascinate", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Support", "action": "Full", "traits": "", "limits": "", "resourceCost": "", "description": "Through fancy footwork, vicious mockery, or a startling performance, you draw the attention of those nearby.\n\nRegardless of your result, targets are temporarily immune to your attempts to Fascinate them for 5 minutes.", "onSuccess": "The target gains the staggered condition.", "dConditions": "C:Staggered", "tEffect": "C:Staggered", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Performance", "skill": "Performance", "defense": "Insight DC", "range": "3", "rType": "Threat", "target": "Up to three targets", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "impersonator":
			return { "name": "Impersonator", "augmentBase": "", "techniqueGroup": "Acumen", "techniqueSubGroup": "", "techniqueType": "Permanent", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "If you spend 5 minutes studying a person you are trying to impersonate, you gain +1 advantage on all deception checks to pass yourself off as that person.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Trained in Deception", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "second wind":
			return { "name": "Second Wind", "augmentBase": "", "techniqueGroup": "Class", "techniqueSubGroup": "Fighter", "techniqueType": "Job", "action": "Swift", "traits": "", "limits": "1/Round", "resourceCost": "1 Vitality", "description": "You take a breath and refocus your senses. You restore your HP to full.", "onSuccess": "", "dConditions": "", "tEffect": "H:Vitality", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Shrug It Off", "Undaunted"] }
		case "shrug it off":
			return { "name": "Shrug It Off", "augmentBase": "Second Wind", "techniqueGroup": "Class", "techniqueSubGroup": "Fighter", "techniqueType": "Job", "action": "Swift", "traits": "", "limits": "", "resourceCost": "", "description": "You may remove one condition that is affecting you.", "onSuccess": "", "dConditions": "", "tEffect": "R:Condition", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "undaunted":
			return { "name": "Undaunted", "augmentBase": "Second Wind", "techniqueGroup": "Class", "techniqueSubGroup": "Fighter", "techniqueType": "Job", "action": "Swift", "traits": "", "limits": "", "resourceCost": "3 Mana; 1 Chakra", "description": "Remove 1 Wound from yourself. In 5 minutes, or when you choose to do so early, you take 1 Wound.", "onSuccess": "", "dConditions": "", "tEffect": "R:Wound", "rEffect": "", "trigger": "", "requirement": "You have a wound.", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "always armored":
		...
		case "bursting spellshot":
			return { "name": "Bursting Spellshot", "augmentBase": "Spellshot", "techniqueGroup": "Class", "techniqueSubGroup": "Marksman", "techniqueType": "Job", "action": "Swift", "traits": "", "limits": "", "resourceCost": "1 Chakra", "description": "Until the end of your turn, when you use the Barrage technique you may immediately cast one spell with the volatile trait. The spell must target the target of your barrage or if the spell is an area they must be the target space for the spell. ", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "sharpshooter":
			return { "name": "Sharpshooter", "augmentBase": "", "techniqueGroup": "Class", "techniqueSubGroup": "Marksman", "techniqueType": "Support", "action": "Swift", "traits": "", "limits": "", "resourceCost": "", "description": "Your range with Bow and Longarm weapons increases by 3 until the end of your turn.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Advanced Sharpshooter"] }
		...
		case "savior's retaliation":
			return { "name": "Savior's Retaliation", "augmentBase": "Savior", "techniqueGroup": "Class", "techniqueSubGroup": "Guardian", "techniqueType": "Job", "action": "Reaction", "traits": "", "limits": "", "resourceCost": "1 Mana", "description": "After the attack against you is resolved you may immediately usd the Skirmish technique against the attacking character. ", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		...
		case "spellstrike":
			return { "name": "Spellstrike", "augmentBase": "", "techniqueGroup": "Class", "techniqueSubGroup": "Spellblade", "techniqueType": "Job", "action": "Swift", "traits": "Affinity; AP (All)", "limits": "1/Round", "resourceCost": "1 Mana", "description": "You infuse your weapon with your elemental affinity. ", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "You hit an adjacent creature with a melee attack.", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "Mod", "dVal": "3", "dType": "3", "dBonus": "", "damageType": "Energy", "element": "", "augments": [] }
		case "power skirmish":
		...
		case "nightingale":
			return { "name": "Nightingale", "augmentBase": "Emergency Care", "techniqueGroup": "Class", "techniqueSubGroup": "Physician", "techniqueType": "Job", "action": "Full", "traits": "", "limits": "", "resourceCost": "5 Mana", "description": "The target may restore their HP to full without spending 1 Vitality.", "onSuccess": "", "dConditions": "", "tEffect": "H:Full", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "rhapsody":
		...
		case "sprint":
			return { "name": "Sprint", "augmentBase": "", "techniqueGroup": "Class", "techniqueSubGroup": "Athlete", "techniqueType": "Job", "action": "Swift", "traits": "", "limits": "1/Round", "resourceCost": "", "description": "You may move up to your speed. During this movement you ignore engagement and your movement does not provoke reactions.", "onSuccess": "", "dConditions": "S:Engaged", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Sprint Pass", "Bounding Sprint"] }
		case "sprint pass":
			return { "name": "Sprint Pass", "augmentBase": "Sprint", "techniqueGroup": "Class", "techniqueSubGroup": "Athlete", "techniqueType": "Job", "action": "Swift", "traits": "", "limits": "", "resourceCost": "", "description": "You may also move through enemies' spaces during this movement. ", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		...
		case "shape material":
			return { "name": "Shape Material", "augmentBase": "", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Support", "action": "Full", "traits": "Material", "limits": "", "resourceCost": "1 Mana", "description": "You may craft an item using Tier 1 material dust. The item you craft can be created in an adjacent space or immediately donned into yours or a willing adjacent character's gear slot.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "1", "rType": "Threat", "target": "One Target", "targetCode": "Field", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Quickcraft", "Improved Shaping", "Greater Shaping", "Legendary Shaping"] }
		case "quickcraft":
		...
		case "improved shaping":
			return { "name": "Improved Shaping", "augmentBase": "Shape Material", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Support", "action": "Full", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "You may craft an item using Tier 2 material dust.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 3", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "greater shaping":
			return { "name": "Greater Shaping", "augmentBase": "Shape Material", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Support", "action": "Full", "traits": "", "limits": "", "resourceCost": "3 Mana", "description": "You may craft an item using Tier 3 material dust.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 5", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "legendary shaping":
			return { "name": "Legendary Shaping", "augmentBase": "Shape Material", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Support", "action": "Full", "traits": "", "limits": "", "resourceCost": "4 Mana", "description": "You may craft an item using Tier 4 material dust.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 8", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "dust material":
			return { "name": "Dust Material", "augmentBase": "", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Action", "action": "Full", "traits": "Material", "limits": "", "resourceCost": "1 Mana", "description": "You may destroy an item made of Tier 1 material into dust.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "Structure", "defense": "Brace DC", "range": "3", "rType": "Threat", "target": "One Target", "targetCode": "Field", "dVal": "3", "dType": "6", "dBonus": "", "damageType": "Energy", "element": "", "augments": ["Dust Area", "Improved Dusting", "Greater Dusting", "Legendary Dusting"] }
		case "dust area":
			return { "name": "Dust Area", "augmentBase": "Dust Material", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Action", "action": "Full", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 2", "skill": "", "defense": "", "range": "1", "rType": "Threat", "target": "Cone 2", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "improved dusting":
			return { "name": "Improved Dusting", "augmentBase": "Dust Material", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Action", "action": "Full", "traits": "", "limits": "", "resourceCost": "3 Mana", "description": "You may also target Tier 2 material.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 3", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "4", "dType": "6", "dBonus": "", "damageType": "Energy", "element": "", "augments": [] }
		case "greater dusting":
			return { "name": "Greater Dusting", "augmentBase": "Dust Material", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Action", "action": "Full", "traits": "", "limits": "", "resourceCost": "4 Mana", "description": "You may also target Tier 2 or 3 material.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 5", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "5", "dType": "6", "dBonus": "", "damageType": "Energy", "element": "", "augments": [] }
		case "legendary dusting":
			return { "name": "Legendary Dusting", "augmentBase": "Dust Material", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Action", "action": "Full", "traits": "", "limits": "", "resourceCost": "5 Mana", "description": "You may also target Tier 2, Tier 3, or Tier 4 material.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 8", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "6", "dType": "6", "dBonus": "", "damageType": "Energy", "element": "", "augments": [] }
		case "create pillar":
			return { "name": "Create Pillar", "augmentBase": "", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Action", "action": "Full", "traits": "Affinity [M]; Focus [F]", "limits": "", "resourceCost": "2 Mana", "description": "You create a pillar in a space within range. The pillar is size 1 but 2 spaces high. The attack block and on hit listings only apply if a character is in the space you place the pillar. You may optionally choose to make the pillar raise slowly enough that it does not do damage.", "onSuccess": "The target gains the launched status and is pushed 1 space in a direction of their choosing.", "dConditions": "C:Launched", "tEffect": "C:Launched", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 2", "skill": "Structure", "defense": "PR DC", "range": "3", "rType": "Range", "target": "One Space", "targetCode": "Field", "dVal": "1", "dType": "6", "dBonus": "", "damageType": "Force", "element": "", "augments": ["Create Wall", "Scattered Pillars", "Great Wall"] }
		case "create wall":
		...
		case "scattered pillars":
			return { "name": "Scattered Pillars", "augmentBase": "Create Pillar", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Action", "action": "Full", "traits": "", "limits": "", "resourceCost": "4 Mana", "description": "You create two additional pillars within range.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 4", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "great wall":
		...
		case "aegis":
			return { "name": "Aegis", "augmentBase": "Shield Block", "techniqueGroup": "Arcane", "techniqueSubGroup": "Creation", "techniqueType": "Support", "action": "Reaction", "traits": "", "limits": "", "resourceCost": "4 Mana", "description": "The hit becomes a miss.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 5", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "camoflauge":
		...
		case "entangle":
			return { "name": "Entangle", "augmentBase": "Cultivate", "techniqueGroup": "Wood", "techniqueSubGroup": "Basic", "techniqueType": "Support", "action": "Full", "traits": "Focus", "limits": "", "resourceCost": "2 Mana", "description": "You cause ether to mimic the plant material and overgrow the area. The area becomes difficult terrain.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 2", "skill": "", "defense": "", "range": "3", "rType": "Range", "target": "Blast 1", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "wildwood":
			return { "name": "Wildwood", "augmentBase": "Cultivate", "techniqueGroup": "Wood", "techniqueSubGroup": "Basic", "techniqueType": "Support", "action": "Full", "traits": "Focus [F]", "limits": "", "resourceCost": "3 Mana", "description": "You cause ether to mimic the plant material and overgrow the area. The area becomes difficult terrain.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 3", "skill": "", "defense": "", "range": "5", "rType": "Range", "target": "Blast 2", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "sicken":
			return { "name": "Sicken", "augmentBase": "", "techniqueGroup": "Wood", "techniqueSubGroup": "Poison", "techniqueType": "Active", "action": "Full", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "You launch poisonous spores at your target.", "onSuccess": "The target gains the sickened condition.", "dConditions": "C:Sickened", "tEffect": "C:Sickened", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Poison Branch; Spellforce 2", "skill": "Assault", "defense": "Fortitude", "range": "3", "rType": "Range", "target": "One Target", "targetCode": "Single", "dVal": "1", "dType": "3", "dBonus": "", "damageType": "Tension", "element": "", "augments": ["Spores", "Sickening Cloud", "Virulent Spores"] }
		case "spores":
		...
		case "updraft":
			return { "name": "Updraft", "augmentBase": "", "techniqueGroup": "Wood", "techniqueSubGroup": "Wind", "techniqueType": "Support", "action": "Reaction", "traits": "Focus", "limits": "1/Round", "resourceCost": "", "description": "You cause a sustained updraft on the ground below the target. This spell disperses fog, dust, and other particles in the same area. \n\nThose who make a vertical jump in the area increase their jump height by 3 spaces. Characters that end a fall within the area treat falls as 4 spaces shorter.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "You or another character within range jump or fall.", "requirement": "", "prerequisite": "Wind Branch", "skill": "", "defense": "", "range": "5", "rType": "Threat", "target": "One Space", "targetCode": "Field", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Great Updraft"] }
		case "great updraft":
			return { "name": "Great Updraft", "augmentBase": "Updraft", "techniqueGroup": "Wood", "techniqueSubGroup": "Wind", "techniqueType": "Support", "action": "Reaction", "traits": "", "limits": "", "resourceCost": "1 Mana", "description": "", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "Blast 2", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "wind step":
			return { "name": "Wind Step", "augmentBase": "", "techniqueGroup": "Wood", "techniqueSubGroup": "Wind", "techniqueType": "Passive", "action": "Free", "traits": "", "limits": "", "resourceCost": "", "description": "Your speed increases by 1.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Wind Branch; Spellforce 2", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Wind Fall", "Walk on Air"] }
		case "wind fall":
		...
		case "blurred light":
			return { "name": "Blurred Light", "augmentBase": "", "techniqueGroup": "Fire", "techniqueSubGroup": "Light", "techniqueType": "Support", "action": "Full", "traits": "Focus [F]", "limits": "", "resourceCost": "1 Mana", "description": "As long as you remain in dim or darker light, you become invisible until the end of your next turn. Taking any action other than Stadard Move, Dash, or Hide breaks this invisibility.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Light Branch; Spellforce 2", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "Field", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Light Refraction"] }
		...
		case "flash":
			return { "name": "Flash", "augmentBase": "Light", "techniqueGroup": "Fire", "techniqueSubGroup": "Light", "techniqueType": "Passive", "action": "Swift", "traits": "", "limits": "", "resourceCost": "2 Mana", "description": "As a quick action, you make a single orb of light flare.", "onSuccess": "The target gains the staggered condition.", "dConditions": "C:Staggered", "tEffect": "C:Staggered", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 3", "skill": "Conjure", "defense": "Notice DC", "range": "10", "rType": "Range", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "sunlight":
		...
		case "choking smoke":
			return { "name": "Choking Smoke", "augmentBase": "Smoke Cloud", "techniqueGroup": "Fire", "techniqueSubGroup": "Smoke", "techniqueType": "Support", "action": "Full", "traits": "Volatile", "limits": "", "resourceCost": "3 Mana", "description": "The smoke suffocates those within.", "onSuccess": "The target gains the impaired condition.", "dConditions": "C:Impaired", "tEffect": "C:Impaired", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 3", "skill": "Field", "defense": "Presence DC", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "2", "dType": "6", "dBonus": "", "damageType": "Burn", "element": "Fire", "augments": [] }
		case "fire step":
		...
		case "shadow steps":
			return { "name": "Shadow Steps", "augmentBase": "", "techniqueGroup": "Earth", "techniqueSubGroup": "Shadow", "techniqueType": "Support", "action": "Full", "traits": "Focus [F]", "limits": "", "resourceCost": "1 Mana", "description": "As long as you remain in dim or darker light, you become invisible until the end of your next turn. Taking any action other than Stadard Move, Dash, or Hide breaks this invisibility.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Shadow Branch; Spellforce 2", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "Field", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Shadow Walker"] }
		case "shadow walker":
			return { "name": "Shadow Walker", "augmentBase": "Shadow Steps", "techniqueGroup": "Earth", "techniqueSubGroup": "Shadow", "techniqueType": "Support", "action": "Full", "traits": "", "limits": "", "resourceCost": "4 Mana", "description": "As part of Shadow Steps, you also impart Shadow Steps on all those adjacent to you.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 5", "skill": "", "defense": "", "range": "", "rType": "", "target": "Burst 1", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "darkness":
		...
		case "nightfall":
			return { "name": "Nightfall", "augmentBase": "Darkness", "techniqueGroup": "Earth", "techniqueSubGroup": "Shadow", "techniqueType": "Support", "action": "Quick", "traits": "", "limits": "", "resourceCost": "4 Mana", "description": "This darkness destroys the Sunlight spell's orbs of light.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 5", "skill": "", "defense": "", "range": "", "rType": "", "target": "Blast 3", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "sand surge":
		...
		case "burden":
			return { "name": "Burden", "augmentBase": "", "techniqueGroup": "Earth", "techniqueSubGroup": "Gravity", "techniqueType": "Support", "action": "Full", "traits": "", "limits": "", "resourceCost": "1 Mana", "description": "You force earth to cling to the targen, weighing them down. A creature becomes immune to this technique for 5 minutes after it is used on them.", "onSuccess": "The target gains the encumbered condition.", "dConditions": "C:Encumbered", "tEffect": "C:Encumbered", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "Enchant", "defense": "BP DC", "range": "4", "rType": "Range", "target": "One Target", "targetCode": "Single", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Restrain", "Prostration"] }
		case "restrain":
		...
		case "geyser":
			return { "name": "Geyser", "augmentBase": "", "techniqueGroup": "Water", "techniqueSubGroup": "Basic", "techniqueType": "Active", "action": "Full", "traits": "Volatile", "limits": "", "resourceCost": "2 Mana", "description": "You cause water to blast upward.", "onSuccess": "The target gains the launched status.", "dConditions": "C:Launched", "tEffect": "C:Launched", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "Assault", "defense": "BP DC", "range": "3", "rType": "Range", "target": "One Target", "targetCode": "Single", "dVal": "3", "dType": "6", "dBonus": "", "damageType": "Force", "element": "Water", "augments": ["Geyser Line", "Great Geyser Line"] }
		case "geyser line":
		...
		case "fog cloud":
			return { "name": "Fog Cloud", "augmentBase": "", "techniqueGroup": "Water", "techniqueSubGroup": "Storm", "techniqueType": "Support", "action": "Full", "traits": "Focus", "limits": "", "resourceCost": "1 Mana", "description": "You cause fog to rise from the ground. This fog is thick enough to provide soft cover.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Storm branch", "skill": "", "defense": "", "range": "3", "rType": "Threat", "target": "Blast 1", "targetCode": "Field", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Sleet", "Freezing Sleet", "Binding Sleet"] }
		case "sleet":
			return { "name": "Sleet", "augmentBase": "Fog Cloud", "techniqueGroup": "Water", "techniqueSubGroup": "Storm", "techniqueType": "Support", "action": "Full", "traits": "Volatile", "limits": "", "resourceCost": "2 Mana", "description": "You pelt the area with freezing water before covering it in fog.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "Field", "defense": "Presence DC", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "2", "dType": "6", "dBonus": "", "damageType": "Cold", "element": "Water", "augments": [] }
		case "freezing sleet":
			return { "name": "Freezing Sleet", "augmentBase": "Fog Cloud", "techniqueGroup": "Water", "techniqueSubGroup": "Storm", "techniqueType": "Support", "action": "Full", "traits": "Volatile", "limits": "", "resourceCost": "3 Mana", "description": "You pelt the area with freezing water before covering it in fog.", "onSuccess": "The target gains the chilled condition.", "dConditions": "C:Chilled", "tEffect": "C:Chilled", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 2", "skill": "Field", "defense": "Presence DC", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "2", "dType": "6", "dBonus": "", "damageType": "Cold", "element": "Water", "augments": [] }
		case "binding sleet":
			return { "name": "Binding Sleet", "augmentBase": "Fog Cloud", "techniqueGroup": "Water", "techniqueSubGroup": "Storm", "techniqueType": "Support", "action": "Full", "traits": "Volatile", "limits": "", "resourceCost": "4 Mana", "description": "You pelt the area with freezing water before covering it in fog.", "onSuccess": "The target gains the immobilized condition.", "dConditions": "C:Immobilized", "tEffect": "C:Immobilized", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Spellforce 3", "skill": "Field", "defense": "Presence DC", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "3", "dType": "6", "dBonus": "", "damageType": "Cold", "element": "Water", "augments": [] }
		case "hail":
