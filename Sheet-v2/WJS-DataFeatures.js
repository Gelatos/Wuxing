...
function GetWarfareTechniquesList(isFields) {
	if (isFields) {
		return ["hPUp", "kiStrike", "dropKick", "uppercut", "crushingBlade", "staggeringBlade", "piledriver", "shreddingDriver", "pointBlankShot", "shotOnTheRun", "poleVault", "quickDraw", "rapidVolley", "rushingVolley"];
	}
	else {
		return ["HP Up", "Ki Strike", "Drop Kick", "Uppercut", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Pole Vault", "Quick Draw", "Rapid Volley", "Rushing Volley"];
	}
}
...
function GetAllSkillTechniquesList(isFields) {
	if (isFields) {
		...
		return ["HP Up", "Ki Strike", "Drop Kick", "Uppercut", "Crushing Blade", "Staggering Blade", "Piledriver", "Shredding Driver", "Point Blank Shot", "Shot on the Run", "Pole Vault", "Quick Draw", "Rapid Volley", "Rushing Volley", "Acceleration", "Power Vault", "Expeditious", "Quick Climb", "Quick Swim", "Poise", "Cat Fall", "Kip Up", "Silent Stride", "Shove", "Knockdown", "Tumble", "Field Medic", "Broad Study", "Experienced Tracker", "Multilingual", "Specialized Knowledge", "Improved Initiative", "Create Diversion", "Demoralize", "Fascinate", "Impersonator"];
	}
}
...
function GetTechniquesInfo(name) {
	switch (name.toLowerCase()) {
		...
		case "combat reflexes":
			return { "name": "Combat Reflexes", "augmentBase": "", "techniqueGroup": "General Path", "techniqueSubGroup": "", "techniqueType": "Standard", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "Until the end of the round, your Follow-Up Attack technique can be used 3/Round, but only 1/Turn.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Character Level 4", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Combat Reflexes +"] }
		case "combat reflexes +":
			return { "name": "Combat Reflexes +", "augmentBase": "Combat Reflexes", "techniqueGroup": "General Path", "techniqueSubGroup": "", "techniqueType": "Standard", "action": "Quick", "traits": "", "limits": "", "resourceCost": "", "description": "Increase the round limit to 4/Round, but only 2/Turn.", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "Character Level 24", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		case "refocus":
		...
		case "knock away savior":
			return { "name": "Knock Away Savior", "augmentBase": "Savior", "techniqueGroup": "Class", "techniqueSubGroup": "Guardian", "techniqueType": "Job", "action": "Reaction", "traits": "", "limits": "", "resourceCost": "", "description": "After trading spaces with the defending character, you may move the character up to 2 spaces away. ", "onSuccess": "", "dConditions": "", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": [] }
		...
		case "sprint":
			return { "name": "Sprint", "augmentBase": "", "techniqueGroup": "Class", "techniqueSubGroup": "Athlete", "techniqueType": "Job", "action": "Swift", "traits": "", "limits": "1/Round", "resourceCost": "", "description": "You may move up to half your speed. During this movement you ignore engagement and your movement does not provoke reactions.", "onSuccess": "", "dConditions": "S:Engaged", "tEffect": "", "rEffect": "", "trigger": "", "requirement": "", "prerequisite": "", "skill": "", "defense": "", "range": "", "rType": "", "target": "", "targetCode": "", "dVal": "", "dType": "", "dBonus": "", "damageType": "", "element": "", "augments": ["Sprint Pass", "Bounding Sprint"] }
		case "sprint pass":
