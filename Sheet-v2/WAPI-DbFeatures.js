	...
	var
		...
		values = {
			...
			"Page Set": {
				...
				"abbreviation": "", "variable": "pageSet{0}{1}", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Page": {
				"name": "Page", "fieldName": "page", "title": "Page", "group": "Type", "descriptions": [""],
				"abbreviation": "", "variable": "page{0}{1}", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Character Creator": {
			...
			"_expertise": {
				...
				"abbreviation": "", "variable": "_expertise", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"_error": {
			...
			"Brace": {
				"name": "Brace", "fieldName": "brace", "title": "Brace", "group": "Defense", "descriptions": ["Brace represents a character's ability to resist a physical force and shrug it off by holding strong and blocking. Common uses of this defense are to prevent a fast attack from harming the character or to resist the effect of many pushing effects."],
				"abbreviation": "", "variable": "brace", "formula": "7;Body", "modifiers": "_expertise; _techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Fortitude": {
				"name": "Fortitude", "fieldName": "fortitude", "title": "Fortitude", "group": "Defense", "descriptions": ["Fortitude is your body's defense against afflictions that would attack you internally such as poisons or sickness. "],
				"abbreviation": "", "variable": "fortitude", "formula": "7;Body", "modifiers": "_techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Disruption": {
				"name": "Disruption", "fieldName": "disruption", "title": "Disruption", "group": "Defense", "descriptions": ["Guard represents a character's ability to resist an attack by disrupting its impact via parrying with a weapon or reducing its effectiveness. "],
				"abbreviation": "", "variable": "disruption", "formula": "7;Precision", "modifiers": "_expertise; _techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Hide": {
				"name": "Hide", "fieldName": "hide", "title": "Hide", "group": "Defense", "descriptions": ["Hide is your ability to stay quiet and out of sight while you have the hidden status. "],
				"abbreviation": "", "variable": "hide", "formula": "7;Precision", "modifiers": "_techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Evasion": {
				"name": "Evasion", "fieldName": "evasion", "title": "Evasion", "group": "Defense", "descriptions": ["Evasion is your dodging ability. When an attack checks against any defense and fails, it will always then check against evasion. On failure, the attack does not connect and no aspect of its effects occur."],
				"abbreviation": "", "variable": "evasion", "formula": "4;Quickness", "modifiers": "_techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Reflex": {
				...
				"abbreviation": "", "variable": "reflex", "formula": "7;Quickness", "modifiers": "_expertise; _techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Sense": {
			...
			"Insight": {
				"name": "Insight", "fieldName": "insight", "title": "Insight", "group": "Sense", "descriptions": ["Insight represents a character's ability to sense emotional state and sudden changes in behaviour. It is useful when detecting someone is trying to charm or deceive you. "],
				"abbreviation": "", "variable": "insight", "formula": "7;Intuition ", "modifiers": "_expertise; _techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Notice": {
				"name": "Notice", "fieldName": "notice", "title": "Notice", "group": "Sense", "descriptions": ["Notice is the ability to see or hear sudden changes in your environment. It is typically used to counter a character's sneak attempts or to passively hear effects from afar. "],
				"abbreviation": "", "variable": "notice", "formula": "7;Intuition ", "modifiers": "_techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Scrutiny": {
				"name": "Scrutiny", "fieldName": "scrutiny", "title": "Scrutiny", "group": "Sense", "descriptions": ["Scrutiny represents your ability to find holes in another's logical reasoning. It is often used in defense against another's attempts at lying and from being tripped up against a skilled negotiator. "],
				"abbreviation": "", "variable": "scrutiny", "formula": "7;Reason", "modifiers": "_expertise; _techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Evaluate": {
				"name": "Evaluate", "fieldName": "evaluate", "title": "Evaluate", "group": "Sense", "descriptions": ["Evaluate is your ability to "],
				"abbreviation": "", "variable": "evaluate", "formula": "7;Reason", "modifiers": "_techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Resolve": {
				...
				"abbreviation": "", "variable": "resolve", "formula": "7;Conviction", "modifiers": "_expertise; _techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Freewill": {
				"name": "Freewill", "fieldName": "freewill", "title": "Freewill", "group": "Sense", "descriptions": ["Freewill is a character's sense of self and being. This sense defends against those that would manipulate your soul or memory through enchantments or possession. "],
				"abbreviation": "", "variable": "freewill", "formula": "10;Conviction", "modifiers": "_techBonus", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"General": {
			...
			"Level": {
				"name": "Level", "fieldName": "level", "title": "Character Level", "group": "General", "descriptions": ["A trait that determines a character's general level of experience in the world. It increases as a character receives experience points (XP)."],
				"abbreviation": "Lv", "variable": "base_level", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"CR": {
				"name": "CR", "fieldName": "cR", "title": "Character Rank", "group": "General", "descriptions": ["Your character rank applies to many of the numbers you’ll be recording on your character sheet. This bonus increases as you gain character level."],
				"abbreviation": "CR", "variable": "cr", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"HP": {
				"name": "HP", "fieldName": "hP", "title": "Hit Points", "group": "General", "descriptions": ["Hit Points (HP) are the number of hits a character can take in a conflict. This is the case no matter the type of encounter as HP changes based on the type of encounter one finds themselves in."],
				"abbreviation": "HP", "variable": "hp", "formula": "20;CR*10;Body*2", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Buffer": {
			...
			"EN": {
				"name": "EN", "fieldName": "eN", "title": "Energy", "group": "General", "descriptions": ["Energy is a resource used to power techniques. It is a generic term"],
				"abbreviation": "EN", "variable": "energy", "formula": "2;CR", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Chakra": {
				...
				"abbreviation": "", "variable": "chakra", "formula": "2;CR", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Initiative": {
			...
			"Move Speed": {
				"name": "Move Speed", "fieldName": "moveSpeed", "title": "Move Speed", "group": "General", "descriptions": ["Move Speed is the base number of spaces a character is able to move on their turn when they make a standard move."],
				"abbreviation": "", "variable": "moveSpeed", "formula": "3", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Move Speed Die": {
				"name": "Move Speed Die", "fieldName": "moveSpeedDie", "title": "Move Speed Die", "group": "General", "descriptions": ["At the start of a combat round this value is rolled to determine the number of spaces the character may move. If the value is less than their move speed, the value becomes equal to their move speed. "],
				"abbreviation": "", "variable": "moveSpeedDie", "formula": "6", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"Affinity": {
