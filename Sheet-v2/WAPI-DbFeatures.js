...
var WuxDef = WuxDef || (function () {
	...
	var
		...
		values = {
			...
			"Combat_Strength": {
				"name": "Combat_Strength", "fieldName": "strength", "group": "Combat", "description": "", "variable": "cmb-strength{0}", "title": "Strength", "subGroup": "", "descriptions": ["Strength is used as a damage bonus for some techniques."],
				"abbreviation": "", "formula": "Attribute_BOD", "modifiers": "_tech", "linkedGroups": [],
				"isResource": "", "modAttrs": ["atr-bod", "cmb-strength_tech"],
				"formulaCalculations": [{ "modName": "atr-bod", "value": 0, "multiplier": 1 },
				{ "modName": "cmb-strength_tech", "value": 0, "multiplier": 1 }],
				"extraData": {}
			},
			"Combat_Spellforce": {
				"name": "Combat_Spellforce", "fieldName": "spellforce", "group": "Combat", "description": "", "variable": "cmb-spellforce{0}", "title": "Spellforce", "subGroup": "", "descriptions": ["Spellforce is used as a damage bonus for some techniques."],
			...
			"Technique_Heavy Throw": {
				"name": "Technique_Heavy Throw", "fieldName": "heavy_throw", "group": "Technique", "description": "", "variable": "tch-heavy_throw{0}", "title": "Heavy Throw", "subGroup": "Basic Attack", "descriptions": [""],
				"abbreviation": "", "formula": "6;CR*2;AdvancementTechnique;TrainingTechniques", "modifiers": "", "linkedGroups": [],
				"isResource": "", "modAttrs": [],
				"formulaCalculations": [],
				"extraData": { "tier": null, "affinity": "", "isFree": true }
			...
			"Technique_": {
				...
				"isResource": "", "modAttrs": [],
				"formulaCalculations": [],
				"extraData": { "tier": 0, "affinity": "", "isFree": false }
			},
