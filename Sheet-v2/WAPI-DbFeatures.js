...
var WuxDef = WuxDef || (function () {
	...
	var
		...
		values = {
			...
			"Title_ShowTechnique": {
				"name": "Title_ShowTechnique", "fieldName": "showtechnique", "group": "Title", "description": "", "variable": "ttl-showtechnique{0}", "title": "Show Technique", "subGroup": "", "descriptions": ["Clicking this button will send the technique information to chat, allowing others to see its details."],
				"abbreviation": "", "formula": "", "modifiers": "", "linkedGroups": [],
				"isResource": "", "modAttrs": [],
				"formulaCalculations": [],
				"extraData": {}
