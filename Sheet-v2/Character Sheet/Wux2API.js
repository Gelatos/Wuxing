    ...
    var
        ...
        values = {"Attribute":{"name":"Attribute","fieldName":"attribute","group":"Type","description":"","variable":"atr{0}{1}","title":"Attributes","subGroup":"","descriptions":[""],
            ...
            "Style":{"name":"Style","fieldName":"style","group":"Type","description":"","variable":"sty{0}{1}","title":"Styles","subGroup":"","descriptions":[""],
                "abbreviation":"Style","baseFormula":"2;CR:_max*2;AdvancementTechnique;TrainingTechniques","modifiers":"","formula":{"workers":[{"variableName":"","definitionName":"","value":2,"multiplier":1,"max":0},
                        {"variableName":"adv-cr_max","definitionName":"CR","value":0,"multiplier":2,"max":0},
            ...
            "Training":{"name":"Training","fieldName":"training","group":"Type","description":"","variable":"trn{0}{1}","title":"Training Points","subGroup":"","descriptions":["Training points are gained through training and whenever you level. You can spend training points on bonus build points for both knowledge and techniques. ","Whenever you gain 30 PP, you gain one Training Point."],
                "abbreviation":"Trn","baseFormula":"Level;BonusTraining","modifiers":"","formula":{"workers":[{"variableName":"adv-level","definitionName":"Level","value":0,"multiplier":1,"max":0},
            ...
            "EN":{"name":"EN","fieldName":"en","group":"Untyped","description":"","variable":"en","title":"EN","subGroup":"","descriptions":["EN is a resource used to power techniques. "],
                "abbreviation":"EN","baseFormula":"6;CR*0.5","modifiers":"_tech","formula":{"workers":[{"variableName":"","definitionName":"","value":6,"multiplier":1,"max":0},
            ...
            "Style_Daggerthrow Arte":{"name":"Style_Daggerthrow Arte","fieldName":"style_daggerthrow_arte","group":"Style","description":"","variable":"sty-daggerthrow_arte{0}","title":"Daggerthrow Arte","subGroup":"Throw Weapons","descriptions":["A Throw-focused style that launches thrown daggers at foes in fans or with precision attacks."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Arcane Burst":{"name":"Style_Arcane Burst","fieldName":"style_arcane_burst","group":"Style","description":"","variable":"sty-arcane_burst{0}","title":"Arcane Burst","subGroup":"Evocation","descriptions":["A Throw-focused style that explodes around the caster."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Blasting Flames":{"name":"Style_Blasting Flames","fieldName":"style_blasting_flames","group":"Style","description":"","variable":"sty-blasting_flames{0}","title":"Blasting Flames","subGroup":"Evocation","descriptions":["A Throw-focused style that launches bombs that both explode immediately and after a delayed time for more power."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Shock Bomb":{"name":"Style_Shock Bomb","fieldName":"style_shock_bomb","group":"Style","description":"","variable":"sty-shock_bomb{0}","title":"Shock Bomb","subGroup":"Evocation","descriptions":["A Throw-focused style that creates large bursts of electricity and delayed blast bombs."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Arcane Spellshot":{"name":"Style_Arcane Spellshot","fieldName":"style_arcane_spellshot","group":"Style","description":"","variable":"sty-arcane_spellshot{0}","title":"Arcane Spellshot","subGroup":"Evocation","descriptions":["A Shoot-focused style that creates powerful ranged single target energy attacks to be launched at foes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Arcane Blast":{"name":"Style_Arcane Blast","fieldName":"style_arcane_blast","group":"Style","description":"","variable":"sty-arcane_blast{0}","title":"Arcane Blast","subGroup":"Evocation","descriptions":["A Shoot-focused style that causes energy to blast at a target point and engulf the area."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Lightning Shot":{"name":"Style_Lightning Shot","fieldName":"style_lightning_shot","group":"Style","description":"","variable":"sty-lightning_shot{0}","title":"Lightning Shot","subGroup":"Evocation","descriptions":["A Shoot-focused style that mixes both line piercing lightning attacks and targeted lightning spells that stuns foes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Binding Cold":{"name":"Style_Binding Cold","fieldName":"style_binding_cold","group":"Style","description":"","variable":"sty-binding_cold{0}","title":"Binding Cold","subGroup":"Evocation","descriptions":["A Shoot-focused style that deals with single target spells that can slow or immobilize foes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Whispering Wind":{"name":"Style_Whispering Wind","fieldName":"style_whispering_wind","group":"Style","description":"","variable":"sty-whispering_wind{0}","title":"Whispering Wind","subGroup":"Channelling","descriptions":["A style that allows one to communicate over long distances with the wind."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Fire Field":{"name":"Style_Fire Field","fieldName":"style_fire_field","group":"Style","description":"","variable":"sty-fire_field{0}","title":"Fire Field","subGroup":"Channelling","descriptions":["A Channel-focused style that sets an area aflame burning all who enter."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Ice Storm":{"name":"Style_Ice Storm","fieldName":"style_ice_storm","group":"Style","description":"","variable":"sty-ice_storm{0}","title":"Ice Storm","subGroup":"Channelling","descriptions":["A Channel-focused style that conjures storms of snow and ice to freeze and bind those within."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Arcane Conduit":{"name":"Style_Arcane Conduit","fieldName":"style_arcane_conduit","group":"Style","description":"","variable":"sty-arcane_conduit{0}","title":"Arcane Conduit","subGroup":"Enchantment","descriptions":["An Enchant-focused style that allows one to impart and remove energy into people and objects. This allows one to heat or cool and channel magic into one's weapon attacks."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Freeform Flight":{"name":"Style_Freeform Flight","fieldName":"style_freeform_flight","group":"Style","description":"","variable":"sty-freeform_flight{0}","title":"Freeform Flight","subGroup":"Enchantment","descriptions":["An Enchant-focused style allowing one to fly through the air."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Hellfire":{"name":"Style_Hellfire","fieldName":"style_hellfire","group":"Style","description":"","variable":"sty-hellfire{0}","title":"Hellfire","subGroup":"Evocation","descriptions":["A Throw and Channel-focused style that allows many methods to blanket areas in fire."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Storm Caller":{"name":"Style_Storm Caller","fieldName":"style_storm_caller","group":"Style","description":"","variable":"sty-storm_caller{0}","title":"Storm Caller","subGroup":"Evocation","descriptions":["A Shoot-focused style that wields lightning to directly harm its targets."]
                ,
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Sheer Cold":{"name":"Style_Sheer Cold","fieldName":"style_sheer_cold","group":"Style","description":"","variable":"sty-sheer_cold{0}","title":"Sheer Cold","subGroup":"Evocation","descriptions":["A Shoot and Channel-focused style that slings many binding and slowing spells both at single targets and areas."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Manification":{"name":"Style_Manification","fieldName":"style_manification","group":"Style","description":"","variable":"sty-manification{0}","title":"Manification","subGroup":"Channelling","descriptions":["A Channel-focused style that manipulates magic after its cast to mimic or end its effects. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Light Control":{"name":"Style_Light Control","fieldName":"style_light_control","group":"Style","description":"","variable":"sty-light_control{0}","title":"Light Control","subGroup":"Channelling","descriptions":["A Channel and Enchant-focused style that manipulates light to create illusions and copy imagery. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Darkness Weaving":{"name":"Style_Darkness Weaving","fieldName":"style_darkness_weaving","group":"Style","description":"","variable":"sty-darkness_weaving{0}","title":"Darkness Weaving","subGroup":"Channelling","descriptions":["A Channel and Enchant-focused style that creates darkness to blind, conceal, and harm. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Sound Control":{"name":"Style_Sound Control","fieldName":"style_sound_control","group":"Style","description":"","variable":"sty-sound_control{0}","title":"Sound Control","subGroup":"Channelling","descriptions":["A Channel-focused style that allows distant communication and attacking with sound based attacks."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Ether Magic":{"name":"Style_Ether Magic","fieldName":"style_ether_magic","group":"Style","description":"","variable":"sty-ether_magic{0}","title":"Ether Magic","subGroup":"Enchantment","descriptions":["An Enchant and Resonance-focused style that manipulates ether directly to communicate with others, detect magic, and mimic spells. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"Arcane Conduit","requirements":"You must have Arcane Conduit affinity","tier":null},
            "Style_Time Control":{"name":"Style_Time Control","fieldName":"style_time_control","group":"Style","description":"","variable":"sty-time_control{0}","title":"Time Control","subGroup":"Enchantment","descriptions":["A Enchant-focused style that allows the slowing of time to teleport and prepare actions. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Propelling Force":{"name":"Style_Propelling Force","fieldName":"style_propelling_force","group":"Style","description":"","variable":"sty-propelling_force{0}","title":"Propelling Force","subGroup":"Fluctuation","descriptions":["A Kinesis-focused style that propels an instantaneous force in an area to push targets."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Binding Winds":{"name":"Style_Binding Winds","fieldName":"style_binding_winds","group":"Style","description":"","variable":"sty-binding_winds{0}","title":"Binding Winds","subGroup":"Fluctuation","descriptions":["A Kinesis-focused style uses wind to immobilize foes and prevent allies from freefall."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            ...
            "Style_Dust Impact":{"name":"Style_Dust Impact","fieldName":"style_dust_impact","group":"Style","description":"","variable":"sty-dust_impact{0}","title":"Dust Impact","subGroup":"Fluctuation","descriptions":["A Kinesis-focused style that swings large quantities of dust at targets to strike and push."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Windsweep":{"name":"Style_Windsweep","fieldName":"style_windsweep","group":"Style","description":"","variable":"sty-windsweep{0}","title":"Windsweep","subGroup":"Fluctuation","descriptions":["A Kinesis-focused style that creates powerful winds to restrain and lift."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Gravity Force":{"name":"Style_Gravity Force","fieldName":"style_gravity_force","group":"Style","description":"","variable":"sty-gravity_force{0}","title":"Gravity Force","subGroup":"Fluctuation","descriptions":["A Kinesis-focused style that creates powerful vertical forces to lift and restrain. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Telekinesis":{"name":"Style_Telekinesis","fieldName":"style_telekinesis","group":"Style","description":"","variable":"sty-telekinesis{0}","title":"Telekinesis","subGroup":"Fluctuation","descriptions":["A Kinesis-focused style that combines the ability to levitate objects with many techniques that allow one to attack with these objects."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Surging Water":{"name":"Style_Surging Water","fieldName":"style_surging_water","group":"Style","description":"","variable":"sty-surging_water{0}","title":"Surging Water","subGroup":"Fluctuation","descriptions":["A Kinesis-focused style that leverages large amounts of water to push and batter targets."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            ...
            "Style_Structural Magic":{"name":"Style_Structural Magic","fieldName":"style_structural_magic","group":"Style","description":"","variable":"sty-structural_magic{0}","title":"Structural Magic","subGroup":"Conjury","descriptions":["A Conjure-focused style that makes large structures that can work as paths or walls."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Arbormaking":{"name":"Style_Arbormaking","fieldName":"style_arbormaking","group":"Style","description":"","variable":"sty-arbormaking{0}","title":"Arbormaking","subGroup":"Conjury","descriptions":["A Conjure-focused style that allows the creation of trees as individual elements and walls."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Stonemaking":{"name":"Style_Stonemaking","fieldName":"style_stonemaking","group":"Style","description":"","variable":"sty-stonemaking{0}","title":"Stonemaking","subGroup":"Conjury","descriptions":["A Conjure-focused style that uses rock to create walls, both in parts and as massive lines."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Iron Walls":{"name":"Style_Iron Walls","fieldName":"style_iron_walls","group":"Style","description":"","variable":"sty-iron_walls{0}","title":"Iron Walls","subGroup":"Conjury","descriptions":["A Conjure-focused style using steel to quickly put up walls that remain sturdy and consume less space."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Glacial Walls":{"name":"Style_Glacial Walls","fieldName":"style_glacial_walls","group":"Style","description":"","variable":"sty-glacial_walls{0}","title":"Glacial Walls","subGroup":"Conjury","descriptions":["A Conjure-focused style that uses ice as walls that can create chilling and damaging fields."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Clouded Shroud":{"name":"Style_Clouded Shroud","fieldName":"style_clouded_shroud","group":"Style","description":"","variable":"sty-clouded_shroud{0}","title":"Clouded Shroud","subGroup":"Conjury","descriptions":["A Conjure-focused style that creates clouds of dust that can obscure and slash at foes."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Floral Shroud":{"name":"Style_Floral Shroud","fieldName":"style_floral_shroud","group":"Style","description":"","variable":"sty-floral_shroud{0}","title":"Floral Shroud","subGroup":"Conjury","descriptions":["A Conjure-focused style that creates pollen and petals that can obscure and sicken with smelling pollen."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Smoke Field":{"name":"Style_Smoke Field","fieldName":"style_smoke_field","group":"Style","description":"","variable":"sty-smoke_field{0}","title":"Smoke Field","subGroup":"Conjury","descriptions":["A Conjure-focused style that creates clouds of smoke to hide and choke."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Misty Terrtain":{"name":"Style_Misty Terrtain","fieldName":"style_misty_terrtain","group":"Style","description":"","variable":"sty-misty_terrtain{0}","title":"Misty Terrtain","subGroup":"Conjury","descriptions":["A Conjure-focused style that creates obscuring mist that can hide and freeze."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            ...
            "Style_Unshaping":{"name":"Style_Unshaping","fieldName":"style_unshaping","group":"Style","description":"","variable":"sty-unshaping{0}","title":"Unshaping","subGroup":"Transmulation","descriptions":["A Shape-focused style allowing one to destroy material into dust."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Plant Growth":{"name":"Style_Plant Growth","fieldName":"style_plant_growth","group":"Style","description":"","variable":"sty-plant_growth{0}","title":"Plant Growth","subGroup":"Transmulation","descriptions":["A Shape-focused style that alters plantlife into entangling roots and thorny bramble patches."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Calming Blooms":{"name":"Style_Calming Blooms","fieldName":"style_calming_blooms","group":"Style","description":"","variable":"sty-calming_blooms{0}","title":"Calming Blooms","subGroup":"Transmulation","descriptions":["A Shape-focused style that provides healing through calming meadows and aromas."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Verdant Armory":{"name":"Style_Verdant Armory","fieldName":"style_verdant_armory","group":"Style","description":"","variable":"sty-verdant_armory{0}","title":"Verdant Armory","subGroup":"Transmulation","descriptions":["A Shape-focused style that molds plantlife into armor and spiny walls and cacti."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Terrain Molding":{"name":"Style_Terrain Molding","fieldName":"style_terrain_molding","group":"Style","description":"","variable":"sty-terrain_molding{0}","title":"Terrain Molding","subGroup":"Transmulation","descriptions":["A Shape-focused style that molds earth into new terrain."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Ground Splitter":{"name":"Style_Ground Splitter","fieldName":"style_ground_splitter","group":"Style","description":"","variable":"sty-ground_splitter{0}","title":"Ground Splitter","subGroup":"Transmulation","descriptions":["A Shape-focused style that cracks the earth with holes and quakes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Earthen Armory":{"name":"Style_Earthen Armory","fieldName":"style_earthen_armory","group":"Style","description":"","variable":"sty-earthen_armory{0}","title":"Earthen Armory","subGroup":"Transmulation","descriptions":["A Shape-focused style that molds earth into armor and walls."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Water Shape":{"name":"Style_Water Shape","fieldName":"style_water_shape","group":"Style","description":"","variable":"sty-water_shape{0}","title":"Water Shape","subGroup":"Transmulation","descriptions":["A Shape-focused style that changes water into slicks to slow or healing fields."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Icy Terrain":{"name":"Style_Icy Terrain","fieldName":"style_icy_terrain","group":"Style","description":"","variable":"sty-icy_terrain{0}","title":"Icy Terrain","subGroup":"Transmulation","descriptions":["A Shape-focused style that freezes water to create slippery pathways and allows quick traversal for the caster."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Frozen Armory":{"name":"Style_Frozen Armory","fieldName":"style_frozen_armory","group":"Style","description":"","variable":"sty-frozen_armory{0}","title":"Frozen Armory","subGroup":"Transmulation","descriptions":["A Shape-focused style that molds ice into shields and walls."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Healing Hands":{"name":"Style_Healing Hands","fieldName":"style_healing_hands","group":"Style","description":"","variable":"sty-healing_hands{0}","title":"Healing Hands","subGroup":"Physiomancy","descriptions":["A Heal-focused style that allows one to use healing magic to mend wounds and end debilitating conditions."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Earthen Endurance":{"name":"Style_Earthen Endurance","fieldName":"style_earthen_endurance","group":"Style","description":"","variable":"sty-earthen_endurance{0}","title":"Earthen Endurance","subGroup":"Physiomancy","descriptions":["A Heal-focused style providing strong defenses and allowing one to carry more."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Propelling Motion":{"name":"Style_Propelling Motion","fieldName":"style_propelling_motion","group":"Style","description":"","variable":"sty-propelling_motion{0}","title":"Propelling Motion","subGroup":"Physiomancy","descriptions":["A Heal-focused style granting additional movement options to run and leap."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            ...
            "Style_Structural Mastery":{"name":"Style_Structural Mastery","fieldName":"style_structural_mastery","group":"Style","description":"","variable":"sty-structural_mastery{0}","title":"Structural Mastery","subGroup":"Conjury","descriptions":["A Conjure-focused style that makes large structures that can work as paths, columns, or walls."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Poison Spore":{"name":"Style_Poison Spore","fieldName":"style_poison_spore","group":"Style","description":"","variable":"sty-poison_spore{0}","title":"Poison Spore","subGroup":"Conjury","descriptions":["A Conjure-focused style that creates clouds of poisonous spores and antidotes for these poisons."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Geomancy":{"name":"Style_Geomancy","fieldName":"style_geomancy","group":"Style","description":"","variable":"sty-geomancy{0}","title":"Geomancy","subGroup":"Transmulation","descriptions":["A Shape-focused style that alters the terrain with rocks, lava, and quakes."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Cryomancy":{"name":"Style_Cryomancy","fieldName":"style_cryomancy","group":"Style","description":"","variable":"sty-cryomancy{0}","title":"Cryomancy","subGroup":"Transmulation","descriptions":["A Shape-focused style that alters the terrain with ice, storms, and walls."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Soul Surge":{"name":"Style_Soul Surge","fieldName":"style_soul_surge","group":"Style","description":"","variable":"sty-soul_surge{0}","title":"Soul Surge","subGroup":"Physiomancy","descriptions":["A Heal-focused branch style that bolsters the body through empowerment of the soul providing healing and strength. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Blood Flux":{"name":"Style_Blood Flux","fieldName":"style_blood_flux","group":"Style","description":"","variable":"sty-blood_flux{0}","title":"Blood Flux","subGroup":"Physiomancy","descriptions":["A Heal-focused branch style allowing the manipulation of blood to both paralyze and cleanse. This magic is generally considered taboo in all cultures. "],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            ...
            "Stat_Frightened":{"name":"Stat_Frightened","fieldName":"stat_frightened","group":"Status","description":"","variable":"sts-frightened{0}","title":"Frightened","subGroup":"Emotion","descriptions":["A frightened character has +1 disadvantage on attack rolls against the source of its fear. The character can’t willingly move closer to the source. A frightened character can only have one character be the target of this emotion and will have the target replaced by a new target if this emotion is gained again."],
                ...
                "linkedGroups":[],
                "isResource":"","shortDescription":"","points":"8","endsOnRoundStart":false,"endsOnTrigger":false},
            "Stat_Flustered":{"name":"Stat_Flustered","fieldName":"stat_flustered","group":"Status","description":"","variable":"sts-flustered{0}","title":"Flustered","subGroup":"Emotion","descriptions":["All skill checks against a flustered target receive +1 Advantage and persuade checks against the target increase by 3. ","This Emotion ends when it is triggered."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","shortDescription":"","points":"5","endsOnRoundStart":false,"endsOnTrigger":true},
