...
var TargetReference = TargetReference || (function () {
    ...
    var schemaVersion = "0.1.3",
        ...
        iterateOverActiveTargetData = function (callback) {
            Debug.Log(`[TargetReference][iterateOverActiveTargetData] Iterating over activeCharacters target data.\n${JSON.stringify(Object.keys(state.TargetReference.activeCharacters.targetData))}`);
        ...
        addToActiveCharacters = function (tokenTargetData) {
            ...
            Debug.Log(`[TargetReference][addToActiveCharacters] Adding ${tokenTargetData.charName} to active characters.`);
...
var TokenReference = TokenReference || (function () {
    ...
    var schemaVersion = "0.1.0",
        ...
        getTokenDataFromTargetData = function (targetData) {
            Debug.Log(`[TokenReference][getTokenDataFromTargetData] Getting token data for ${targetData.charName}`);
        ...
        getTokenDataFromId = function (tokenId) {
            Debug.Log(`[TokenReference][getTokenDataFromId] Getting token data for ${tokenId}`);
