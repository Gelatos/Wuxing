    ...
    var
        ...
        values = {"Attribute":{"name":"Attribute","fieldName":"attribute","group":"Type","description":"","variable":"atr{0}{1}","title":"Attributes","subGroup":"","descriptions":[""],
            ...
            "StyleSubGroup_Acrobatics":{"name":"StyleSubGroup_Acrobatics","fieldName":"acrobatics","group":"StyleSubGroup","description":"","variable":"stylesubgroup-acrobatics{0}","title":"Acrobatics","subGroup":"Athletics","descriptions":[""],
                ...
                "linkedGroups":[],
                "isResource":""},
            "StyleSubGroup_Requesting":{"name":"StyleSubGroup_Requesting","fieldName":"requesting","group":"StyleSubGroup","description":"","variable":"stylesubgroup-requesting{0}","title":"Requesting","subGroup":"Speechcraft","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            "StyleSubGroup_EmotionalStrategy":{"name":"StyleSubGroup_EmotionalStrategy","fieldName":"emotionalstrategy","group":"StyleSubGroup","description":"","variable":"stylesubgroup-emotionalstrategy{0}","title":"Emotional Strategy","subGroup":"Speechcraft","descriptions":[""],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":""},
            ...
            "Style_Reactive Defense":{"name":"Style_Reactive Defense","fieldName":"style_reactive_defense","group":"Style","description":"","variable":"sty-reactive_defense{0}","title":"Reactive Defense","subGroup":"Acrobatics","descriptions":["An Agility and Physique-focused style with a focus on evasive attacks and counters."],
                ...
                "linkedGroups":[],
                "isResource":"","mainGroup":"Advanced","affinity":"","requirements":"None","tier":null},
            "Style_Avowed":{"name":"Style_Avowed","fieldName":"style_avowed","group":"Style","description":"","variable":"sty-avowed{0}","title":"Avowed","subGroup":"Requesting","descriptions":["An Inspire-focused style that encourages greatness in others to inspire action."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Social Grace":{"name":"Style_Social Grace","fieldName":"style_social_grace","group":"Style","description":"","variable":"sty-social_grace{0}","title":"Social Grace","subGroup":"Requesting","descriptions":["A Charm-focused style used to forge connection through charming talk and simple proposals."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Flattery":{"name":"Style_Flattery","fieldName":"style_flattery","group":"Style","description":"","variable":"sty-flattery{0}","title":"Flattery","subGroup":"Requesting","descriptions":["A Charm-focused style allowing you to manipulate others to your whims, beguiling them for your desires."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Deft Negotiator":{"name":"Style_Deft Negotiator","fieldName":"style_deft_negotiator","group":"Style","description":"","variable":"sty-deft_negotiator{0}","title":"Deft Negotiator","subGroup":"Requesting","descriptions":["A Rationalize-focused style allowing you to break will to gain others' trust and quickly bring them to the correct decision."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Sales Tactics":{"name":"Style_Sales Tactics","fieldName":"style_sales_tactics","group":"Style","description":"","variable":"sty-sales_tactics{0}","title":"Sales Tactics","subGroup":"Requesting","descriptions":["A Rationalize-focused style to pressure others into action and to make a quick purchase."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Invigorating Rally":{"name":"Style_Invigorating Rally","fieldName":"style_invigorating_rally","group":"Style","description":"","variable":"sty-invigorating_rally{0}","title":"Invigorating Rally","subGroup":"Emotional Strategy","descriptions":["An Inspire-focused style that motivates others through encouraging words and providing benefits to end conditions."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Taunting Wit":{"name":"Style_Taunting Wit","fieldName":"style_taunting_wit","group":"Style","description":"","variable":"sty-taunting_wit{0}","title":"Taunting Wit","subGroup":"Emotional Strategy","descriptions":["A Demoralize-focused style about provoking anger out of foes to make yourself their target or to redirect it elsewhere."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Underminer":{"name":"Style_Underminer","fieldName":"style_underminer","group":"Style","description":"","variable":"sty-underminer{0}","title":"Underminer","subGroup":"Emotional Strategy","descriptions":["A Demoralize-focused style where you use your words to stave off manipulators and taunt them into giving up."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Intimidating Fear":{"name":"Style_Intimidating Fear","fieldName":"style_intimidating_fear","group":"Style","description":"","variable":"sty-intimidating_fear{0}","title":"Intimidating Fear","subGroup":"Emotional Strategy","descriptions":["A Demoralize-focused style used to frighten others into submitting themselves to your demands. And if fear doesn't work, anger can do just as well."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Beguiling Instinct":{"name":"Style_Beguiling Instinct","fieldName":"style_beguiling_instinct","group":"Style","description":"","variable":"sty-beguiling_instinct{0}","title":"Beguiling Instinct","subGroup":"Manipulation","descriptions":["A Misdirect-focused style that charms others into listening to you and sows seeds of doubt to damage their will."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Stillheart":{"name":"Style_Stillheart","fieldName":"style_stillheart","group":"Style","description":"","variable":"sty-stillheart{0}","title":"Stillheart","subGroup":"Manipulation","descriptions":["An Empathy-focused style making It hard to attack your willpower due to your tranquil aura and to influence others' motivations."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
            "Style_Connecting Bond":{"name":"Style_Connecting Bond","fieldName":"style_connecting_bond","group":"Style","description":"","variable":"sty-connecting_bond{0}","title":"Connecting Bond","subGroup":"Manipulation","descriptions":["An Empathy-focused style allowing you to heal others' willpower damage and reveal their motivations."],
                "abbreviation":"","baseFormula":"","modifiers":"","formula":{"workers":[]},
                "linkedGroups":[],
                "isResource":"","mainGroup":"Style","affinity":"","requirements":"None","tier":null},
