...
var WuxDef = WuxDef || (function () {
	...
	var
		keys = ["Attribute", "Body", "Precision", "Quickness", "Conviction", "Intuition ", "Reason", "Skill", "Job", "Knowledge", "Language", "Lore", "Style", "Technique", "Defense", "Brace", "Disruption", "Evasion", "Sense", "Insight", "Scrutiny", "Resolve", "Awareness", "Fortitude", "Notice", "Hide", "Reflex", "General", "Character Level", "Character Rank", "Hit Points", "Buffer", "Energy", "Focus", "Chakra", "Initiative", "Speed", "Affinity", "Wood", "Fire", "Earth", "Metal", "Water", "Gear", "Carrying Capacity", "Reflex Penalty", "Speed Penalty", "Combat", "Durability", "Heal Value", "Barrier", "Block", "Armor", "Trauma Limit", "Stress Limit", "Vitality", "Ki", "Armsforce", "Spellforce", "Strikeforce", "Social", "Willpower", "Approval", "Patience", "Tech Slot", "Job Slots", "Item Slots", "Active Slots", "Support Slots", "Character Creator", "Origin", "Origin Basics", "Full Name", "Display Name", "Accurate", "Affinity+", "AP (X)", "Brutal", "Focus+", "Material", "Simple", "Volatile", "Vortex", "Weapon", "Wall", "Arcing", "Shield", "Thrown", "Two-Handed", "Loud", "Impact (X)", "Explosive (X/Y)", "Flammable", "Flexible", "Frozen", "Sharp", "Sturdy", "Transparent", "Downed", "Engaged", "Ethereal", "Grappled", "Hidden", "Initiative Penalty", "Invisible", "Restrained", "Unconscious", "Aflame", "Angered", "Chilled", "Delayed", "Disgusted", "Dying", "Empowered", "Encouraged", "Encumbered", "Frightened", "Hasted", "Immobilized", "Impaired", "Joyful", "Launched", "Paralyzed", "Prone", "Saddened", "Sickened", "Staggered", "Stunned", "Surprised", "Acrobatics", "Agility", "Analyze", "Build", "Channel", "Charm", "Command", "Concoct", "Cook", "Deception", "Disguise", "Empathy", "Enchant", "Finesse", "Flexibility", "Grappling", "Heal", "Intimidation", "Leadership", "Maneuver", "Medicine", "Might", "Negotiation", "Palming", "Physique", "Pilot", "Resonance", "Search", "Shoot", "Skirmish", "Sneak", "Survival", "Throw", "Tinker", "Traversal", "Minere", "Junal", "Apollen", "Lib", "Cert", "Byric", "Dustell", "Muralic", "Shira", "Ciel", "Citeq", "Manstan", "Salkan", "Sansic", "Silq", "Kleikan", "Crinere", "Palmic", "Shorespeak", "Verdeni", "Vulca", "Emotion", "Wolfwarg", "Jovean", "Mytikan", "Academics", "Health", "Mana", "Mathematics", "Nature", "School", "Spirit", "Warfare", "Zoology", "Profession", "Farming", "Fishing", "Hunting", "Legal", "Mercantile", "Mining", "Craftmanship", "Alchemy", "Architecture", "Brewing", "Cooking", "Engineering", "Glassblowing", "Leatherworking", "Sculpting", "Smithing", "Weaving", "Geography", "Aridsha", "Ceres", "Colswei", "Khem", "Novus", "Walthair", "Wayling", "Ethereal Plane", "History", "Aridsha History", "Ceres History", "Colswei History", "Khem History", "Novus History", "Walthair History", "Wayling History", "Culture", "Art", "Etiquette", "Fashion", "Games", "Music", "Scribing", "Theater", "Religion", "Church of Kongkwei", "Guidance", "Life's Circle", "Ocean Court", "Sylvan", "Zushaon", "Trainee", "Interceptor", "Guardian", "Spellslinger", "Warrior", "Rogue", "Scholar", "Physician", "Generalist", "Defender", "Athlete", "Skirmisher", "Marksman"],
		values = {
			"Attribute": {
				...
				"abbreviation": "", "variable": "", "formula": "", "modifiers": "undefined"
			},
			"Body": {
				"name": "Body", "title": "Body", "group": "Attribute", "descriptions": [""],
				"abbreviation": "BOD", "variable": "bod{0}", "formula": "", "modifiers": "undefined"
			},
			"Precision": {
				"name": "Precision", "title": "Precision", "group": "Attribute", "descriptions": [""],
				"abbreviation": "PRC", "variable": "prc{0}", "formula": "", "modifiers": "undefined"
			},
			"Quickness": {
				"name": "Quickness", "title": "Quickness", "group": "Attribute", "descriptions": [""],
				"abbreviation": "QCK", "variable": "qck{0}", "formula": "", "modifiers": "undefined"
			},
			"Conviction": {
				"name": "Conviction", "title": "Conviction", "group": "Attribute", "descriptions": [""],
				"abbreviation": "CNV", "variable": "cnv{0}", "formula": "", "modifiers": "undefined"
			},
			"Intuition ": {
				"name": "Intuition ", "title": "Intuition ", "group": "Attribute", "descriptions": [""],
				"abbreviation": "INT", "variable": "int{0}", "formula": "", "modifiers": "undefined"
			},
			"Reason": {
				"name": "Reason", "title": "Reason", "group": "Attribute", "descriptions": [""],
				"abbreviation": "RSN", "variable": "rsn{0}", "formula": "", "modifiers": "undefined"
			},
			"Skill": {
				"name": "Skill", "title": "Skill", "group": "Stat", "descriptions": [""],
				"abbreviation": "", "variable": "skill{0}{1}", "formula": "8", "modifiers": "undefined"
			},
			"Job": {
				"name": "Job", "title": "Jobs", "group": "Stat", "descriptions": [""],
				"abbreviation": "", "variable": "job{0}{1}", "formula": "1", "modifiers": "undefined"
			},
			"Knowledge": {
				"name": "Knowledge", "title": "", "group": "", "descriptions": [""],
				"abbreviation": "", "variable": "knowledge{0}{1}", "formula": "10", "modifiers": "undefined"
			},
			"Language": {
				"name": "Language", "title": "Language", "group": "Stat", "descriptions": [""],
				"abbreviation": "", "variable": "language{0}{1}", "formula": "", "modifiers": "undefined"
			},
			"Lore": {
				"name": "Lore", "title": "Lore", "group": "Stat", "descriptions": [""],
				"abbreviation": "", "variable": "lore{0}{1}", "formula": "", "modifiers": "undefined"
			},
			"Style": {
				"name": "Style", "title": "Style", "group": "Stat", "descriptions": [""],
				"abbreviation": "", "variable": "style{0}{1}", "formula": "", "modifiers": "undefined"
			},
			"Technique": {
				"name": "Technique", "title": "Techniques", "group": "Stat", "descriptions": [""],
				"abbreviation": "", "variable": "technique{0}{1}", "formula": "6", "modifiers": "undefined"
			},
			"Defense": {
				"name": "Defense", "title": "Defense", "group": "Type", "descriptions": ["A defense protects a character from physical harm"],
				"abbreviation": "", "variable": "defense", "formula": "", "modifiers": "undefined"
			},
			"Brace": {
				...
				"abbreviation": "", "variable": "brace", "formula": "7;bod", "modifiers": "undefined"
			},
			"Disruption": {
				...
				"abbreviation": "", "variable": "disruption", "formula": "7;prc", "modifiers": "undefined"
			},
			"Evasion": {
				...
				"abbreviation": "", "variable": "evasion", "formula": "qck", "modifiers": "undefined"
			},
			"Sense": {
			...
			"Insight": {
				...
				"abbreviation": "", "variable": "insight", "formula": "7;int", "modifiers": "undefined"
			},
			"Scrutiny": {
				...
				"abbreviation": "", "variable": "scrutiny", "formula": "7;rsn", "modifiers": "undefined"
			},
			"Resolve": {
				...
				"abbreviation": "", "variable": "resolve", "formula": "7;cnv", "modifiers": "undefined"
			},
			"Awareness": {
			...
			"Fortitude": {
				...
				"abbreviation": "", "variable": "fortitude", "formula": "7;bod", "modifiers": "undefined"
			},
			"Notice": {
				...
				"abbreviation": "", "variable": "notice", "formula": "7;int", "modifiers": "undefined"
			},
			"Hide": {
				"name": "Hide", "title": "Hide", "group": "Awareness", "descriptions": [""],
				"abbreviation": "", "variable": "hide", "formula": "7;prc", "modifiers": "undefined"
			},
			"Reflex": {
				...
				"abbreviation": "", "variable": "reflex", "formula": "7;qck", "modifiers": "undefined"
			},
			"General": {
			...
			"Character Level": {
				...
				"abbreviation": "Lv", "variable": "base_level", "formula": "", "modifiers": "undefined"
			},
			"Character Rank": {
				...
				"abbreviation": "CR", "variable": "cr", "formula": "", "modifiers": "undefined"
			},
			"Hit Points": {
				...
				"abbreviation": "HP", "variable": "hp", "formula": "", "modifiers": "undefined"
			},
			"Buffer": {
			...
			"Focus": {
				...
				"abbreviation": "", "variable": "focus", "formula": "1", "modifiers": "undefined"
			},
			"Chakra": {
				...
				"abbreviation": "", "variable": "chakra", "formula": "Path", "modifiers": "undefined"
			},
			"Initiative": {
				...
				"abbreviation": "", "variable": "initiative", "formula": "qck", "modifiers": "undefined"
			},
			"Speed": {
				...
				"abbreviation": "", "variable": "speed", "formula": "!Ancestry; speed_penalty", "modifiers": "undefined"
			},
			"Affinity": {
				...
				"abbreviation": "", "variable": "affinity", "formula": "", "modifiers": "undefined"
			},
			"Wood": {
				"name": "Wood", "title": "Wood", "group": "Affinity", "descriptions": [""],
				"abbreviation": "", "variable": "wood", "formula": "", "modifiers": "undefined"
			},
			"Fire": {
				"name": "Fire", "title": "Fire", "group": "Affinity", "descriptions": [""],
				"abbreviation": "", "variable": "fire", "formula": "", "modifiers": "undefined"
			},
			"Earth": {
				"name": "Earth", "title": "Earth", "group": "Affinity", "descriptions": [""],
				"abbreviation": "", "variable": "earth", "formula": "", "modifiers": "undefined"
			},
			"Metal": {
				"name": "Metal", "title": "Metal", "group": "Affinity", "descriptions": [""],
				"abbreviation": "", "variable": "metal", "formula": "", "modifiers": "undefined"
			},
			"Water": {
				"name": "Water", "title": "Water", "group": "Affinity", "descriptions": [""],
				"abbreviation": "", "variable": "water", "formula": "", "modifiers": "undefined"
			},
			"Gear": {
			...
			"Carrying Capacity": {
				...
				"abbreviation": "", "variable": "carry_capacity", "formula": "40; bodRank", "modifiers": "undefined"
			},
			"Reflex Penalty": {
				...
				"abbreviation": "", "variable": "reflex_penalty", "formula": "!Gear", "modifiers": "undefined"
			},
			"Speed Penalty": {
				...
				"abbreviation": "", "variable": "speed_penalty", "formula": "!Gear", "modifiers": "undefined"
			},
			"Combat": {
			...
			"Durability": {
				...
				"abbreviation": "", "variable": "durability", "formula": "Character Rank * 10", "modifiers": "undefined"
			},
			"Heal Value": {
				...
				"abbreviation": "HV", "variable": "hv", "formula": "Character Rank * 2", "modifiers": "undefined"
			},
			"Barrier": {
				...
				"abbreviation": "", "variable": "barrier", "formula": "prc", "modifiers": "undefined"
			},
			"Block": {
				...
				"abbreviation": "", "variable": "block", "formula": "!Gear", "modifiers": "undefined"
			},
			"Armor": {
				...
				"abbreviation": "", "variable": "armor", "formula": "!Gear", "modifiers": "undefined"
			},
			"Trauma Limit": {
				...
				"abbreviation": "", "variable": "trauma", "formula": "1", "modifiers": "undefined"
			},
			"Stress Limit": {
				...
				"abbreviation": "", "variable": "stress", "formula": "3", "modifiers": "undefined"
			},
			"Vitality": {
				...
				"abbreviation": "", "variable": "vitality", "formula": "2", "modifiers": "undefined"
			},
			"Ki": {
				...
				"abbreviation": "", "variable": "ki", "formula": "3", "modifiers": "undefined"
			},
			"Armsforce": {
			...
			"Willpower": {
				...
				"abbreviation": "", "variable": "willpower", "formula": "cnv", "modifiers": "undefined"
			},
			"Approval": {
				...
				"abbreviation": "", "variable": "approval", "formula": "cnv", "modifiers": "undefined"
			},
			"Patience": {
				...
				"abbreviation": "", "variable": "patience", "formula": "pb*10;int", "modifiers": "undefined"
			},
			"Tech Slot": {
			...
			"Job Slots": {
				...
				"abbreviation": "", "variable": "techslot-job", "formula": "1", "modifiers": "undefined"
			},
			"Item Slots": {
				"name": "Item Slots", "title": "Item Slots", "group": "Tech Slot", "descriptions": [""],
				"abbreviation": "", "variable": "techslot-item", "formula": "", "modifiers": "undefined"
			},
			"Active Slots": {
				...
				"abbreviation": "", "variable": "techslot-active", "formula": "1", "modifiers": "undefined"
			},
			"Support Slots": {
				...
				"abbreviation": "", "variable": "techslot-support", "formula": "1", "modifiers": "undefined"
			},
			"Character Creator": {
			...
			"Origin": {
				...
				"abbreviation": "", "variable": "origin{0}{1}", "formula": "", "modifiers": "undefined"
			},
			"Origin Basics": {
				"name": "Origin Basics", "title": "Basics", "group": "Definition", "descriptions": [""],
				"abbreviation": "", "variable": "origin_basics{0}{1}", "formula": "", "modifiers": "undefined"
			},
			"Full Name": {
				...
				"abbreviation": "", "variable": "full_name", "formula": "", "modifiers": "undefined"
			},
			"Display Name": {
				...
				"abbreviation": "", "variable": "display_name", "formula": "", "modifiers": "undefined"
			},
			"Accurate": {
			...
			"Acrobatics": {
				"name": "Acrobatics", "title": "Acrobatics", "group": "Skill", "descriptions": ["Your Acrobatics check covers your attempt to stay on your feet in a tricky situation, such as when you’re trying to run across a sheet of ice, balance on a tightrope, or stay upright on a rocking ship’s deck. "],
				"abbreviation": "", "variable": "acrobatics", "formula": "", "modifiers": ""
			},
			"Agility": {
				"name": "Agility", "title": "Agility", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "agility", "formula": "", "modifiers": ""
			},
			"Analyze": {
				"name": "Analyze", "title": "Analyze", "group": "Skill", "descriptions": ["When attempting to find clues and make deductions based on those clues, you make an Analyze check. You might deduce the location of a hidden object, discern from the appearance of a wound what kind of weapon dealt it, or determine the weakest point in a tunnel that could cause it to collapse. Poring through books in search of a hidden fragment of knowledge might also call for an Analyze check."],
				"abbreviation": "", "variable": "analyze", "formula": "", "modifiers": ""
			},
			"Build": {
				"name": "Build", "title": "Build", "group": "Skill", "descriptions": ["Build is the skill to create structures and objects. This skill includes several different forms of artistic impression such as through drawing, sculpting, handcrafting of fine objects, and conveying art and information through images and technique. "],
				"abbreviation": "", "variable": "build", "formula": "", "modifiers": ""
			},
			"Channel": {
				"name": "Channel", "title": "Channel", "group": "Skill", "descriptions": ["Channel is the skill to maintain concentration on ether you have manipulated in order to continue its effects. Magical effects that create a sustained area of effect typically use channel to determine their effectiveness."],
				"abbreviation": "", "variable": "channel", "formula": "", "modifiers": ""
			},
			"Charm": {
				"name": "Charm", "title": "Charm", "group": "Skill", "descriptions": ["Enticing, fascinating, and endearing others to you on a personal basis. It can be used to win someone over emotionally through friendliness, joy, and an ability to read a situation. "],
				"abbreviation": "", "variable": "charm", "formula": "", "modifiers": ""
			},
			"Command": {
				"name": "Command", "title": "Command", "group": "Skill", "descriptions": ["Command is the ability to use perceived authority or intimidation to control another's perceptions and action. One may use command to inspire a companion, intimidate a foe into backing down, or when making demands of another. "],
				"abbreviation": "", "variable": "command", "formula": "", "modifiers": ""
			},
			"Concoct": {
				"name": "Concoct", "title": "Concoct", "group": "Skill", "descriptions": ["Concoct is the skill of combining ingredients inorder to create a new product. If you are cooking a meal, making medicine, or otherwise blending items together to form a new item you would use the mix skill."],
				"abbreviation": "", "variable": "concoct", "formula": "", "modifiers": ""
			},
			"Cook": {
				"name": "Cook", "title": "Cook", "group": "Skill", "descriptions": ["Cook allows one to create food and drinks from ingredients. Food is an important fuel to sustain life but also well made food improves mood and allows one to push themselves."],
				"abbreviation": "", "variable": "cook", "formula": "", "modifiers": ""
			},
			"Deception": {
				"name": "Deception", "title": "Deception", "group": "Skill", "descriptions": ["Deception is the skill of telling convincing lies, as well as feigning emotion, belief, or frame of mind. Deception can encompass everything from misleading others through ambiguity to telling outright lies. This skill is also used to convince others of a disguise. "],
				"abbreviation": "", "variable": "deception", "formula": "", "modifiers": ""
			},
			"Disguise": {
				"name": "Disguise", "title": "Disguise", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "disguise", "formula": "", "modifiers": ""
			},
			"Empathy": {
				"name": "Empathy", "title": "Empathy", "group": "Skill", "descriptions": ["Empathy is used to sense both feelings in other creatures and any existing mana or ether in the environment. ", "A language of the spirits. This language is communicated through thought and ether, allowing creatures of any type to understand."],
				"abbreviation": "", "variable": "empathy", "formula": "", "modifiers": ""
			},
			"Enchant": {
				"name": "Enchant", "title": "Enchant", "group": "Skill", "descriptions": ["Enchant is the skill to control ones own ether and impart it into another person or object. This is the basis for techniques like healing and empowerment magic."],
			...
			"Flexibility": {
				"name": "Flexibility", "title": "Flexibility", "group": "Skill", "descriptions": ["Your flexibility check covers your attempt to stay on your feet in a tricky situation, such as when you’re trying to run across a sheet of ice, balance on a tightrope, or stay upright on a rocking ship’s deck. "],
				"abbreviation": "", "variable": "flexibility", "formula": "", "modifiers": ""
			},
			"Grappling": {
				"name": "Grappling", "title": "Grappling", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "grappling", "formula": "", "modifiers": ""
			},
			"Heal": {
				"name": "Heal", "title": "Heal", "group": "Skill", "descriptions": ["Heal is used to perform medical procedures such as administering drugs, performing first aid, and conducting surgeries. It includes long-term medical support for disease and illness, and the skill can be used to diagnose a character’s medical condition."],
				"abbreviation": "", "variable": "heal", "formula": "", "modifiers": ""
			},
			"Intimidation": {
				"name": "Intimidation", "title": "Intimidation", "group": "Skill", "descriptions": ["When you attempt to influence someone through overt threats, hostile actions, and physical violence, you make an Intimidation check. Examples include trying to pry information out of a prisoner, convincing street thugs to back down from a confrontation, or using the edge of a broken bottle to convince a sneering vizier to reconsider a decision. When intimidating others you target their resolve."],
				"abbreviation": "", "variable": "intimidation", "formula": "", "modifiers": ""
			},
			"Leadership": {
				"name": "Leadership", "title": "Leadership", "group": "Skill", "descriptions": ["Leadership is the ability to direct and motivate others. This skill is especially helpful in situations where the will of a teammate is shaken or someone is being asked to do something uncomfortable."],
				"abbreviation": "", "variable": "leadership", "formula": "", "modifiers": ""
			},
			"Maneuver": {
				"name": "Maneuver", "title": "Maneuver", "group": "Skill", "descriptions": ["Maneuvers govern techniques that allow you to move or manipulate another creature into a new position or state."]
				,
				"abbreviation": "", "variable": "maneuver", "formula": "", "modifiers": ""
			},
			"Medicine": {
				"name": "Medicine", "title": "Medicine", "group": "Skill", "descriptions": ["Medicine is the skill to create and administer drugs for yourself and others. Drugs are often used both to quickly provide a temporary boost to another and to administer long term care for another."],
				"abbreviation": "", "variable": "medicine", "formula": "", "modifiers": ""
			},
			"Might": {
				"name": "Might", "title": "Might", "group": "Skill", "descriptions": ["This skill allows one to attack with brute strength while wielding heavy and cumbersome weapons. These weapons support large damage values allowing their wielders to smash through their enemies. Weapons in this group often will pierce through armor or exploit a reflex vulnerability. "],
				"abbreviation": "", "variable": "might", "formula": "", "modifiers": ""
			},
			"Negotiation": {
				"name": "Negotiation", "title": "Negotiation", "group": "Skill", "descriptions": ["Negotiation governs a character’s ability to apply their charisma, tactics, and knowledge of situational psychology in order to create a better position when making deals."],
				"abbreviation": "", "variable": "negotiation", "formula": "", "modifiers": ""
			},
			"Palming": {
				"name": "Palming", "title": "Palming", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "palming", "formula": "", "modifiers": ""
			},
			"Physique": {
				"name": "Physique", "title": "Physique", "group": "Skill", "descriptions": ["The Physique skill represents a character’s raw strength and endurance. It is used when using physical strength to break through objects and restraints or when attempting to lift things beyond your carrying capacity."],
				"abbreviation": "", "variable": "physique", "formula": "", "modifiers": ""
			},
			"Pilot": {
				"name": "Pilot", "title": "Pilot", "group": "Skill", "descriptions": ["When attempting to drive a vehicle of any kind, the pilot skill often governs most checks. "],
				"abbreviation": "", "variable": "pilot", "formula": "", "modifiers": ""
			},
			"Resonance": {
				"name": "Resonance", "title": "Resonance", "group": "Skill", "descriptions": ["Resonance is the ability to detect and release ether. It is most often used to detect magical structures and as communication with spirits. Less commonly, it can be used to destroy magical effects and structures made from ether that hasn't been permanently bound."],
				"abbreviation": "", "variable": "resonance", "formula": "", "modifiers": ""
			},
			"Search": {
				"name": "Search", "title": "Search", "group": "Skill", "descriptions": ["This is used to actively search for for clues or anything out of sorts. You might deduce the location of a hidden object, discern from the appearance of a wound what kind of weapon dealt it, or determine the weakest point in a tunnel that could cause it to collapse. "],
				"abbreviation": "", "variable": "search", "formula": "", "modifiers": ""
			},
			"Shoot": {
				"name": "Shoot", "title": "Shoot", "group": "Skill", "descriptions": ["The skill of using a bow or firearm. These weapons have the most variety in weapon ranges allowing one to reliably attack from a distance. "],
				"abbreviation": "", "variable": "shoot", "formula": "", "modifiers": ""
			},
			"Skirmish": {
				"name": "Skirmish", "title": "Skirmish", "group": "Skill", "descriptions": ["This skill governs most balanced, close range fighting styles such as with longswords, clubs, and polearms. Weapons in this category offer the most variety of technique options to manipulate the battlefield to their favor. Unique to this group are weapons that can exploit both reflex and brace vulnerabilities."],
				"abbreviation": "", "variable": "skirmish", "formula": "", "modifiers": ""
			},
			"Sneak": {
				"name": "Sneak", "title": "Sneak", "group": "Skill", "descriptions": ["Make a Sneak check when you attempt to conceal yourself from enemies, palm an object, slink past guards, slip away without being noticed, or sneak up on some one without being seen or heard. "],
				"abbreviation": "", "variable": "sneak", "formula": "", "modifiers": ""
			},
			"Survival": {
				"name": "Survival", "title": "Survival", "group": "Skill", "descriptions": ["Survival is the ability to stay alive in ex- treme environmental conditions for extended periods of time. The skill governs a character’s ability to per- form vital outdoor tasks such as start a fire, build a shel- ter, scrounge for food, etc."],
				"abbreviation": "", "variable": "survival", "formula": "", "modifiers": ""
			},
			"Throw": {
				"name": "Throw", "title": "Throw", "group": "Skill", "descriptions": ["When one strikes at a foe or aims for a location by throwing an object, it is typical to use the throw skill. Many melee weapons will have a range increment. In order to use this range the user will instead use the Throw skill to determine accuracy."],
				"abbreviation": "", "variable": "throw", "formula": "", "modifiers": ""
			},
			"Tinker": {
				"name": "Tinker", "title": "Tinker", "group": "Skill", "descriptions": ["This skill covers building, repairing, and disabling mechanical devices such as locks, tools, and machinery."],
				"abbreviation": "", "variable": "tinker", "formula": "", "modifiers": ""
			},
			"Traversal": {
				"name": "Traversal", "title": "Traversal", "group": "Skill", "descriptions": ["Your traversal check covers movement through an environment such as when climbing, jumping, or swimming."],
				"abbreviation": "", "variable": "traversal", "formula": "", "modifiers": ""
			},
			"Minere": {
				"name": "Minere", "title": "Minere", "group": "Language", "descriptions": ["The common language used in Minerva and the lands surrounding it. Minere is made up of three root languages that were once spoken commonly amongst the coastal civilizations of the area."],
				"abbreviation": "", "variable": "minere", "formula": "", "modifiers": ""
			},
			"Junal": {
				"name": "Junal", "title": "Junal", "group": "Language", "descriptions": ["Juno's major language and the official language of the Guidance. Those who live within or below the city of Juno are expected to learn and speak this language to fully integrate into society."],
				"abbreviation": "", "variable": "junal", "formula": "", "modifiers": ""
			},
			"Apollen": {
				"name": "Apollen", "title": "Apollen", "group": "Language", "descriptions": ["The common tongue of Apollo, this language uses a variety of symbols in written works. It is one of the oldest languages still in use in modern times. In the Blessed lands it is known as Mons, the language of the mountainous people, the Monsen."],
				"abbreviation": "", "variable": "apollen", "formula": "", "modifiers": ""
			},
			"Lib": {
				"name": "Lib", "title": "Lib", "group": "Language", "descriptions": ["This language is commonly used in Liber. Its roots seem entirely locked to the region, however the age of the language itself are unclear due to it not being used in written form until much later than its equivalents."],
				"abbreviation": "", "variable": "lib", "formula": "", "modifiers": ""
			},
			"Cert": {
				"name": "Cert", "title": "Cert", "group": "Language", "descriptions": ["The most commonly spoken language in all of Ceres, this language is the original tongue used by the Choi clan. To most in modern times, this connection to the Choi clan is lost but it can often be made clear in the company of those of the clan."],
				"abbreviation": "", "variable": "cert", "formula": "", "modifiers": ""
			},
			"Byric": {
				"name": "Byric", "title": "Byric", "group": "Language", "descriptions": ["The dialect of the tribes of people that live in the Baryan Ascent, north of the Aridsha Desert. It has many common traits with the neighboring dialect of Dustell."],
				"abbreviation": "", "variable": "byric", "formula": "", "modifiers": ""
			},
			"Dustell": {
				"name": "Dustell", "title": "Dustell", "group": "Language", "descriptions": ["This language has many derrivatives across the tribes of the desert. However each version, while distinct in its pronunciations, share a common written form derrived from the Shira language. Due to its use throughout the desert, it is Juno's second most common language."],
				"abbreviation": "", "variable": "dustell", "formula": "", "modifiers": ""
			},
			"Muralic": {
				"name": "Muralic", "title": "Muralic", "group": "Language", "descriptions": ["The language of the Murali people in the deserts of Aridsha. Its roots in Shira are clear and may be even closer to the ancient language than Junal."],
				"abbreviation": "", "variable": "muralic", "formula": "", "modifiers": ""
			},
			"Shira": {
				"name": "Shira", "title": "Shira", "group": "Language", "descriptions": ["An old language that evolved into both the Junal and Muralic languages. Usage can still be found in ancient Guidance relics."],
				"abbreviation": "", "variable": "shira", "formula": "", "modifiers": ""
			},
			"Ciel": {
				"name": "Ciel", "title": "Ciel", "group": "Language", "descriptions": ["This language is used almost exclusively by Clan Par, the historians of Ceres. Those who learn the language often do so to share in the clan's protection and love of the stories and values of Ceres."],
				"abbreviation": "", "variable": "ciel", "formula": "", "modifiers": ""
			},
			"Citeq": {
				"name": "Citeq", "title": "Citeq", "group": "Language", "descriptions": ["A spoken language used mostly by the Ceresian tribes that roam the south western plains of Ceres. "],
				"abbreviation": "", "variable": "citeq", "formula": "", "modifiers": ""
			},
			"Manstan": {
				"name": "Manstan", "title": "Manstan", "group": "Language", "descriptions": ["The spoken language used in Southern Ceresian tribes. It has mostly fallen out of favor due to many of the tribes in this location having settled into Sanctum life, however many who wish to remember older times still speak this language."],
				"abbreviation": "", "variable": "manstan", "formula": "", "modifiers": ""
			},
			"Salkan": {
				"name": "Salkan", "title": "Salkan", "group": "Language", "descriptions": ["An entirely spoken language used by the Ceresian tribes located in the North west Salkandu region. It is most commonly known as the language of Clan Han."],
				"abbreviation": "", "variable": "salkan", "formula": "", "modifiers": ""
			},
			"Sansic": {
				"name": "Sansic", "title": "Sansic", "group": "Language", "descriptions": ["The spoken language used in Eastern Ceresian tribes. It has mostly fallen out of favor due to many of the tribes in this location having settled into Sanctum life, however many who wish to remember older times still speak this language."],
				"abbreviation": "", "variable": "sansic", "formula": "", "modifiers": ""
			},
			"Silq": {
				"name": "Silq", "title": "Silq", "group": "Language", "descriptions": ["The spoken language used in Western Ceresian forest tribes. This language is not often heard due to the forest peoples' exclusion from most of Ceres society in modern times."],
				"abbreviation": "", "variable": "silq", "formula": "", "modifiers": ""
			},
			"Kleikan": {
				"name": "Kleikan", "title": "Kleikan", "group": "Language", "descriptions": ["This spoken language was once the language of the Suntouched people that lived west of the Khembalung Mountain range. It's largely fallen out of favor but pockets of people still try to keep the language alive."],
				"abbreviation": "", "variable": "kleikan", "formula": "", "modifiers": ""
			},
			"Crinere": {
				"name": "Crinere", "title": "Crinere", "group": "Language", "descriptions": ["The ancient language of the civilization of Metis. It has fallen out of favor for the modern Minere and is the basis for said language. Due to how similar the two languages are, many who speak Minere find themselves able to understand the scriptures of Crinere."],
				"abbreviation": "", "variable": "crinere", "formula": "", "modifiers": ""
			},
			"Palmic": {
				"name": "Palmic", "title": "Palmic", "group": "Language", "descriptions": ["This spoken language is used exclusively in tropical island nations. In modern times it only sees common use by tribes in the region, however its language is often used in the tourism industry to imbue a sense of exoticism."],
				"abbreviation": "", "variable": "palmic", "formula": "", "modifiers": ""
			},
			"Shorespeak": {
				"name": "Shorespeak", "title": "Shorespeak", "group": "Language", "descriptions": ["A spoken language used by those living along the east coast and in island nations across the sea. While it has no written language, its similarities to both Minere and ancient Vulca make it easy to communicate across cultures regardless."],
				"abbreviation": "", "variable": "shorespeak", "formula": "", "modifiers": ""
			},
			"Verdeni": {
				"name": "Verdeni", "title": "Verdeni", "group": "Language", "descriptions": ["The spoken language of the island of Verdant Key. Its peoples' isolation from most of modern society has kept this language in tact to ancient times."],
				"abbreviation": "", "variable": "verdeni", "formula": "", "modifiers": ""
			},
			"Vulca": {
				"name": "Vulca", "title": "Vulca", "group": "Language", "descriptions": ["The ancient language of the civilization of Vulcan. It shares a lot of common traits of Shorespeak and may be its root language. The language has fallen out of favor for both Minere and Shorespeak but can still be found on ancient, Ocean Court relics and Vulcan texts."],
				"abbreviation": "", "variable": "vulca", "formula": "", "modifiers": ""
			},
			"Emotion": {
				"name": "Emotion", "title": "Emotion", "group": "Language", "descriptions": ["The language of the spirits. This language is incredibly simplistic as it is communicated entirely through emotions."],
				"abbreviation": "", "variable": "emotion", "formula": "", "modifiers": ""
			},
			"Wolfwarg": {
				"name": "Wolfwarg", "title": "Wolfwarg", "group": "Language", "descriptions": ["The spoken language of the bestial people, the Cesplangrah. Much of the language is spoken through grunts and growls."],
				"abbreviation": "", "variable": "wolfwarg", "formula": "", "modifiers": ""
			},
			"Jovean": {
				"name": "Jovean", "title": "Jovean", "group": "Language", "descriptions": ["The common language of Novus, this language has been used across the blessed lands for as long as its people were aware. In the mainland, it is known as the language of the civilization of Jove and has largely fallen out of use."],
				"abbreviation": "", "variable": "jovean", "formula": "", "modifiers": ""
			},
			"Mytikan": {
				"name": "Mytikan", "title": "Mytikan", "group": "Language", "descriptions": ["The root language of both Novan and Apollen, Mytikan is a language lost to time in the mainland. Ancient relics still use the language in the Blessed Lands and as such isn't surprising to find it still learned by scholars in Novus society."],
				"abbreviation": "", "variable": "mytikan", "formula": "", "modifiers": ""
			},
			"Academics": {
				"name": "Academics", "title": "Academics", "group": "Lore", "descriptions": ["This represents general education for academic study for the purposes of functioning in modern society."],
				"abbreviation": "", "variable": "academics", "formula": "", "modifiers": ""
			},
			"Health": {
				"name": "Health", "title": "Health", "group": "Lore", "descriptions": ["This covers the study of human physiology and health."],
				"abbreviation": "", "variable": "health", "formula": "", "modifiers": ""
			},
			"Mana": {
				"name": "Mana", "title": "Mana", "group": "Lore", "descriptions": ["The study of ki, ether, and magic. "],
				"abbreviation": "", "variable": "mana", "formula": "", "modifiers": ""
			},
			"Mathematics": {
				"name": "Mathematics", "title": "Mathematics", "group": "Lore", "descriptions": ["Mathematics knowledge represents an understanding of math and calculations."],
				"abbreviation": "", "variable": "mathematics", "formula": "", "modifiers": ""
			},
			"Nature": {
				"name": "Nature", "title": "Nature", "group": "Lore", "descriptions": ["Nature knowledge grants an understanding of various types of plant life and their uses."],
				"abbreviation": "", "variable": "nature", "formula": "", "modifiers": ""
			},
			"School": {
				"name": "School", "title": "School", "group": "Lore", "descriptions": ["This knowledge represents information related to schools, famous educators, and forms of education used in the lands."],
				"abbreviation": "", "variable": "school", "formula": "", "modifiers": ""
			},
			"Spirit": {
				"name": "Spirit", "title": "Spirit", "group": "Lore", "descriptions": ["Spirit knowledge represents an understanding of how spirits behave, their various forms, their interactions with magic and ether, and their abilities to manifest into the material plane."],
				"abbreviation": "", "variable": "spirit", "formula": "", "modifiers": ""
			},
			"Warfare": {
				"name": "Warfare", "title": "Warfare", "group": "Lore", "descriptions": ["Warfare knowledge covers various tactics used in war and the management of an army."],
				"abbreviation": "", "variable": "warfare", "formula": "", "modifiers": ""
			},
			"Zoology": {
				"name": "Zoology", "title": "Zoology", "group": "Lore", "descriptions": ["This knowledge represents physiological knowledge of living creatures of the world."],
				"abbreviation": "", "variable": "zoology", "formula": "", "modifiers": ""
			},
			"Profession": {
				"name": "Profession", "title": "Profession", "group": "Lore", "descriptions": ["Profession is the general knowledge of any kind of job, what they do, and how it is performed."],
				"abbreviation": "", "variable": "profession", "formula": "", "modifiers": ""
			},
			"Farming": {
				"name": "Farming", "title": "Farming", "group": "Lore", "descriptions": ["Farming knowledge covers all aspects of growing and nurturing plantlife in order to provide food"],
				"abbreviation": "", "variable": "farming", "formula": "", "modifiers": ""
			},
			"Fishing": {
				"name": "Fishing", "title": "Fishing", "group": "Lore", "descriptions": ["Fishing knowledge covers all aspects of fishing."],
				"abbreviation": "", "variable": "fishing", "formula": "", "modifiers": ""
			},
			"Hunting": {
				"name": "Hunting", "title": "Hunting", "group": "Lore", "descriptions": ["Hunting knowledge imparts wisdom related to tracking, catching, and killing various creatures."],
				"abbreviation": "", "variable": "hunting", "formula": "", "modifiers": ""
			},
			"Legal": {
				"name": "Legal", "title": "Legal", "group": "Lore", "descriptions": ["Legal knowledge imparts a knowledge of general laws common amongst civilizations and the penalties that may be gained from disobeying them."],
				"abbreviation": "", "variable": "legal", "formula": "", "modifiers": ""
			},
			"Mercantile": {
				"name": "Mercantile", "title": "Mercantile", "group": "Lore", "descriptions": ["Mercantile knowledge grants wisdom related to the buying and selling of goods."],
				"abbreviation": "", "variable": "mercantile", "formula": "", "modifiers": ""
			},
			"Mining": {
				"name": "Mining", "title": "Mining", "group": "Lore", "descriptions": ["Mining knowledge represents information related to breaking apart rock for material."],
				"abbreviation": "", "variable": "mining", "formula": "", "modifiers": ""
			},
			"Craftmanship": {
				"name": "Craftmanship", "title": "Craftmanship", "group": "Lore", "descriptions": ["The knowledge of creating items through manipulation of substances and materials. A knowledge check here will help one identify techniques used to create an object but not necessarily how to recreate it."],
				"abbreviation": "", "variable": "craftmanship", "formula": "", "modifiers": ""
			},
			"Alchemy": {
				"name": "Alchemy", "title": "Alchemy", "group": "Lore", "descriptions": ["Alchemy is the science of substances and how they can change. When working with chemicals and material that on their own should not be consumed, Alchemy will typically apply. Alchemy is typically used in the creation of drugs and substances."],
				"abbreviation": "", "variable": "alchemy", "formula": "", "modifiers": ""
			},
			"Architecture": {
				"name": "Architecture", "title": "Architecture", "group": "Lore", "descriptions": ["This knowledge represents a general knowledge about building design, general points of entry, and potential weaknesses."],
				"abbreviation": "", "variable": "architecture", "formula": "", "modifiers": ""
			},
			"Brewing": {
				"name": "Brewing", "title": "Brewing", "group": "Lore", "descriptions": ["Brewing is the skill that governs any kind of skill the requires the mixing of ingredients into a drink or broth."],
				"abbreviation": "", "variable": "brewing", "formula": "", "modifiers": ""
			},
			"Cooking": {
				"name": "Cooking", "title": "Cooking", "group": "Lore", "descriptions": ["Food is important for survival, so making it enjoyable is a craft of great appreciation. Cooking knowledge gives you the knowledge of different cooking techniques to create meals."],
				"abbreviation": "", "variable": "cooking", "formula": "", "modifiers": ""
			},
			"Engineering": {
				"name": "Engineering", "title": "Engineering", "group": "Lore", "descriptions": ["Engineering knowledge represents an understanding of mechanisms and systems to build complex structures and items."],
				"abbreviation": "", "variable": "engineering", "formula": "", "modifiers": ""
			},
			"Glassblowing": {
				"name": "Glassblowing", "title": "Glassblowing", "group": "Lore", "descriptions": ["When working with and shaping glass, the skill of glassblowing is required."],
				"abbreviation": "", "variable": "glassblowing", "formula": "", "modifiers": ""
			},
			"Leatherworking": {
				"name": "Leatherworking", "title": "Leatherworking", "group": "Lore", "descriptions": ["Leatherworking entails any skills related to skinning and using animal skins for clothing, and items. "],
				"abbreviation": "", "variable": "leatherworking", "formula": "", "modifiers": ""
			},
			"Sculpting": {
				"name": "Sculpting", "title": "Sculpting", "group": "Lore", "descriptions": ["Sculpting allows one to use soft material like clay and shape it into a desired form."],
				"abbreviation": "", "variable": "sculpting", "formula": "", "modifiers": ""
			},
			"Smithing": {
				"name": "Smithing", "title": "Smithing", "group": "Lore", "descriptions": ["Smithing is the skill that allows you to shape various materials, usually metal, into tools of combat or other larger metalic items. "],
				"abbreviation": "", "variable": "smithing", "formula": "", "modifiers": ""
			},
			"Weaving": {
				"name": "Weaving", "title": "Weaving", "group": "Lore", "descriptions": ["Weaving is the skill for putting together and shaping fabrics and cloths into useful material and objects."],
				"abbreviation": "", "variable": "weaving", "formula": "", "modifiers": ""
			},
			"Geography": {
				"name": "Geography", "title": "Geography", "group": "Lore", "descriptions": ["Geography represents general knowledge of terrains and locations within an area."],
				"abbreviation": "", "variable": "geography", "formula": "", "modifiers": ""
			},
			"Aridsha": {
				"name": "Aridsha", "title": "Aridsha", "group": "Lore", "descriptions": ["This check represents geographical knowledge of Juno and the Aridsha desert region to the west. "],
				"abbreviation": "", "variable": "aridsha", "formula": "", "modifiers": ""
			},
			"Ceres": {
				"name": "Ceres", "title": "Ceres", "group": "Lore", "descriptions": ["This check represents geographical knowledge of Capitol City and the Ceres plains to the north."],
				"abbreviation": "", "variable": "ceres", "formula": "", "modifiers": ""
			},
			"Colswei": {
				"name": "Colswei", "title": "Colswei", "group": "Lore", "descriptions": ["This check represents geographical knowledge of Liber and the frozen lands of the Colswei in the south."],
				"abbreviation": "", "variable": "colswei", "formula": "", "modifiers": ""
			},
			"Khem": {
				"name": "Khem", "title": "Khem", "group": "Lore", "descriptions": ["This check represents geographical knowledge of the Kingdom of Apollo and its mountainous region of Khem to the north east."],
				"abbreviation": "", "variable": "khem", "formula": "", "modifiers": ""
			},
			"Novus": {
				"name": "Novus", "title": "Novus", "group": "Lore", "descriptions": ["This check represents geographical knowledge of Novus and the Blessed Lands beyond the ocean."],
				"abbreviation": "", "variable": "novus", "formula": "", "modifiers": ""
			},
			"Walthair": {
				"name": "Walthair", "title": "Walthair", "group": "Lore", "descriptions": ["This check represents geographical knowledge of Minerva and the grasslands and eastern sea islands of Walthair to the east."],
				"abbreviation": "", "variable": "walthair", "formula": "", "modifiers": ""
			},
			"Wayling": {
				"name": "Wayling", "title": "Wayling", "group": "Lore", "descriptions": ["This check represents geographical knowledge of the central grasslands and marsh of Wayling."],
				"abbreviation": "", "variable": "wayling", "formula": "", "modifiers": ""
			},
			"Ethereal Plane": {
				"name": "Ethereal Plane", "title": "Ethereal Plane", "group": "Lore", "descriptions": ["Ethereal Plane knowledge represents known methods of entering the plane, its dangers, qualities, and points of interest within the plane."],
				"abbreviation": "", "variable": "etherealPlane", "formula": "", "modifiers": ""
			},
			"History": {
				"name": "History", "title": "History", "group": "Lore", "descriptions": ["History knowledges represent known history of civilizations and any legends that may exist."],
				"abbreviation": "", "variable": "history", "formula": "", "modifiers": ""
			},
			"Aridsha History": {
				"name": "Aridsha History", "title": "Aridsha History", "group": "Lore", "descriptions": ["This check represents history of Juno and the Aridsha desert region to the west. "],
				"abbreviation": "", "variable": "aridshaHistory", "formula": "", "modifiers": ""
			},
			"Ceres History": {
				"name": "Ceres History", "title": "Ceres History", "group": "Lore", "descriptions": ["This check represents history of Capitol City and the Ceres plains to the north."],
				"abbreviation": "", "variable": "ceresHistory", "formula": "", "modifiers": ""
			},
			"Colswei History": {
				"name": "Colswei History", "title": "Colswei History", "group": "Lore", "descriptions": ["This check represents history of Liber and the frozen lands of the Colswei in the south."],
				"abbreviation": "", "variable": "colsweiHistory", "formula": "", "modifiers": ""
			},
			"Khem History": {
				"name": "Khem History", "title": "Khem History", "group": "Lore", "descriptions": ["This check represents history of the Kingdom of Apollo and its mountainous region of Khem to the north east."],
				"abbreviation": "", "variable": "khemHistory", "formula": "", "modifiers": ""
			},
			"Novus History": {
				"name": "Novus History", "title": "Novus History", "group": "Lore", "descriptions": ["This check represents history of Novus and the Blessed Lands beyond the ocean."],
				"abbreviation": "", "variable": "novusHistory", "formula": "", "modifiers": ""
			},
			"Walthair History": {
				"name": "Walthair History", "title": "Walthair History", "group": "Lore", "descriptions": ["This check represents history of Minerva and the grasslands and eastern sea islands of Walthair to the east."],
				"abbreviation": "", "variable": "walthairHistory", "formula": "", "modifiers": ""
			},
			"Wayling History": {
				"name": "Wayling History", "title": "Wayling History", "group": "Lore", "descriptions": ["This check represents history of the central grasslands and marsh of Wayling."],
				"abbreviation": "", "variable": "waylingHistory", "formula": "", "modifiers": ""
			},
			"Culture": {
				"name": "Culture", "title": "Culture", "group": "Lore", "descriptions": ["Culture knowledge represents information on societal customs, art, and entertainment options."],
				"abbreviation": "", "variable": "culture", "formula": "", "modifiers": ""
			},
			"Art": {
				"name": "Art", "title": "Art", "group": "Lore", "descriptions": ["Art knowledge details information on the world of art and the artists behind famous works of art."],
				"abbreviation": "", "variable": "art", "formula": "", "modifiers": ""
			},
			"Etiquette": {
				"name": "Etiquette", "title": "Etiquette", "group": "Lore", "descriptions": ["Etiquette knowledge represents your study of social customs within specific cultures and societies and will help you avoid embarrassing yourself or causing insult."],
				"abbreviation": "", "variable": "etiquette", "formula": "", "modifiers": ""
			},
			"Fashion": {
				"name": "Fashion", "title": "Fashion", "group": "Lore", "descriptions": ["Fashion knowledge focuses on keeping up with clothing and physical beatuy products."],
				"abbreviation": "", "variable": "fashion", "formula": "", "modifiers": ""
			},
			"Games": {
				"name": "Games", "title": "Games", "group": "Lore", "descriptions": ["Games knowledge covers general understanding of how many games are played whether they are reliant on cards, dice, or other kinds of chance."],
				"abbreviation": "", "variable": "games", "formula": "", "modifiers": ""
			},
			"Music": {
				"name": "Music", "title": "Music", "group": "Lore", "descriptions": ["Music knowledge represents general understanding of sheet music, famous songs and the artists behind them, and an understanding of the industry."],
				"abbreviation": "", "variable": "music", "formula": "", "modifiers": ""
			},
			"Scribing": {
				"name": "Scribing", "title": "Scribing", "group": "Lore", "descriptions": ["Scribing knowledge represents an understanding of how to communicate with the written word and techniques used to write."],
				"abbreviation": "", "variable": "scribing", "formula": "", "modifiers": ""
			},
			"Theater": {
				"name": "Theater", "title": "Theater", "group": "Lore", "descriptions": ["Theater knowledge is the knowledge of the stage, techniques to tell a story, and famous plays."],
				"abbreviation": "", "variable": "theater", "formula": "", "modifiers": ""
			},
			"Religion": {
				"name": "Religion", "title": "Religion", "group": "Lore", "descriptions": ["Religion knowledge represent known tenets, famous people and creatures of the religion, and information about legends, beliefs, and organizations."],
				"abbreviation": "", "variable": "religion", "formula": "", "modifiers": ""
			},
			"Church of Kongkwei": {
				"name": "Church of Kongkwei", "title": "Church of Kongkwei", "group": "Lore", "descriptions": ["The Church of Kongkwei is tied to the creation of the Kingdom of Apollo. It follows the fire god Guong Kongkwei and attempts to follow their goals of expansion and control."],
				"abbreviation": "", "variable": "churchOfKongkwei", "formula": "", "modifiers": ""
			},
			"Guidance": {
				"name": "Guidance", "title": "Guidance", "group": "Lore", "descriptions": ["The Guidance is one of the oldest religions in the world of Wuxing. They seek to give its people advice in times of hardship through the divinations of spirits."],
				"abbreviation": "", "variable": "guidance", "formula": "", "modifiers": ""
			},
			"Life's Circle": {
				"name": "Life's Circle", "title": "Life's Circle", "group": "Lore", "descriptions": ["The Life's Circle is the religion of the Novae. It follows the cycle of life and helps determine a person's role in society through reincarnation and destiny."],
				"abbreviation": "", "variable": "life'sCircle", "formula": "", "modifiers": ""
			},
			"Ocean Court": {
				"name": "Ocean Court", "title": "Ocean Court", "group": "Lore", "descriptions": ["The Ocean Court follows the Ocean Queen, Minerra, and her court of gods that ensure her commandments are followed. Those that revere her and her court do so for her protection and luck whether its in her domain at sea or deep in the lands."],
				"abbreviation": "", "variable": "oceanCourt", "formula": "", "modifiers": ""
			},
			"Sylvan": {
				"name": "Sylvan", "title": "Sylvan", "group": "Lore", "descriptions": ["The Sylvans are a group of powerful spirits that hold dominion over territories across the world. They are creatures of whimsy and chaos, the cause of weather patterns and together, the changing of the seasons."],
				"abbreviation": "", "variable": "sylvan", "formula": "", "modifiers": ""
			},
			"Zushaon": {
				"name": "Zushaon", "title": "Zushaon", "group": "Lore", "descriptions": ["Many Ceresians follow Zushaon, a tradition of ancestor worship. The religion seeks to offer reverence for those that came before and a desire to find ones own place in the world."],
				"abbreviation": "", "variable": "zushaon", "formula": "", "modifiers": ""
			},
			"Trainee": {
				"name": "Trainee", "title": "Trainee", "group": "Lore", "descriptions": ["The trainee is representative of your character learning a skill. It delivers fewer growths at level up and no job techniques. Instead, every level grants points to spend on skills."],
				"abbreviation": "", "variable": "trainee", "formula": "", "modifiers": ""
			},
			"Interceptor": {
				"name": "Interceptor", "title": "Interceptor", "group": "Lore", "descriptions": ["The interceptor is an expert in disrupting others. Prefering weapons with increased threat, interceptors protect their allies by stopping the movement of advancing enemies."],
				"abbreviation": "", "variable": "interceptor", "formula": "", "modifiers": ""
			},
			"Guardian": {
				"name": "Guardian", "title": "Guardian", "group": "Lore", "descriptions": ["The guardian is always on the lookout for their allies. When danger approaches, guardians specialize at getting their allies out of the line of fire. "],
				"abbreviation": "", "variable": "guardian", "formula": "", "modifiers": ""
			},
			"Spellslinger": {
				"name": "Spellslinger", "title": "Spellslinger", "group": "Lore", "descriptions": ["The spellslinger is an expert longshot in both ranged weapons and spells. With their Spellshot technique, they use their ranged weapons to launch explosive spells from safety."],
				"abbreviation": "", "variable": "spellslinger", "formula": "", "modifiers": ""
			},
			"Warrior": {
				"name": "Warrior", "title": "Warrior", "group": "Lore", "descriptions": ["The fighter is about survival. This battle hardened warrior will keep himself from falling through many means to self-heal, aid, and even shrug off wounds. "],
				"abbreviation": "", "variable": "warrior", "formula": "", "modifiers": ""
			},
			"Rogue": {
				"name": "Rogue", "title": "Rogue", "group": "Lore", "descriptions": ["The rogue is an expert at exploiting distractions. They can exploit enemy weaknesses with their sneak attack, both on their turn and during follow-up attacks. "],
				"abbreviation": "", "variable": "rogue", "formula": "", "modifiers": ""
			},
			"Scholar": {
				"name": "Scholar", "title": "Scholar", "group": "Lore", "descriptions": ["The scholar is an expert in history and uses it to always be prepared. In addition to history, scholars are typically knowledgable in a broad array of subjects and will sometimes use it to educate others. In combat, a scholar will use their preparedness to avoid bad situations and help their allies avoid them too."],
				"abbreviation": "", "variable": "scholar", "formula": "", "modifiers": ""
			},
			"Physician": {
				"name": "Physician", "title": "Physician", "group": "Lore", "descriptions": ["The physician is a medical practitioner and expert healer. Their Emergency Care allows them to heal allies and provide them with barrier, eventually allowing them to heal wounds. And if faster healing is necessary, their First aid allows them to perform healing as a Quick action."],
				"abbreviation": "", "variable": "physician", "formula": "", "modifiers": ""
			},
			"Generalist": {
				"name": "Generalist", "title": "Generalist", "group": "Skill", "descriptions": ["Very general"],
				"abbreviation": "", "variable": "generalist", "formula": "", "modifiers": ""
			},
			"Defender": {
				"name": "Defender", "title": "Defender", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "defender", "formula": "", "modifiers": ""
			},
			"Athlete": {
				"name": "Athlete", "title": "Athlete", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "athlete", "formula": "", "modifiers": ""
			},
			"Skirmisher": {
				"name": "Skirmisher", "title": "Skirmisher", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "skirmisher", "formula": "", "modifiers": ""
			},
			"Marksman": {
				"name": "Marksman", "title": "Marksman", "group": "Skill", "descriptions": [""],
				"abbreviation": "", "variable": "marksman", "formula": "", "modifiers": ""
			}
		},
		sortingGroups = { "group": { "Type": ["Attribute", "Defense", "Sense", "Awareness", "General", "Affinity", "Gear", "Combat", "Social", "Tech Slot"], "Attribute": ["Body", "Precision", "Quickness", "Conviction", "Intuition ", "Reason"], "Stat": ["Skill", "Job", "Language", "Lore", "Style", "Technique"], "": ["Knowledge"], "Defense": ["Brace", "Disruption", "Evasion"], "Sense": ["Insight", "Scrutiny", "Resolve"], "Awareness": ["Fortitude", "Notice", "Hide", "Reflex"], "General": ["Character Level", "Character Rank", "Hit Points", "Buffer", "Energy", "Focus", "Chakra", "Initiative", "Speed"], "Affinity": ["Wood", "Fire", "Earth", "Metal", "Water"], "Gear": ["Carrying Capacity", "Reflex Penalty", "Speed Penalty"], "Combat": ["Durability", "Heal Value", "Barrier", "Block", "Armor", "Trauma Limit", "Stress Limit", "Vitality", "Ki", "Armsforce", "Spellforce", "Strikeforce"], "Social": ["Willpower", "Approval", "Patience"], "Tech Slot": ["Job Slots", "Item Slots", "Active Slots", "Support Slots"], "Definition": ["Character Creator", "Origin", "Origin Basics", "Full Name", "Display Name"], "Technique Trait": ["Accurate", "Affinity+", "AP (X)", "Brutal", "Focus+", "Material", "Simple", "Volatile", "Vortex", "Weapon", "Wall"], "Item Trait": ["Arcing", "Shield", "Thrown", "Two-Handed", "Loud", "Impact (X)", "Explosive (X/Y)"], "Material Trait": ["Flammable", "Flexible", "Frozen", "Sharp", "Sturdy", "Transparent"], "Status": ["Downed", "Engaged", "Ethereal", "Grappled", "Hidden", "Initiative Penalty", "Invisible", "Restrained", "Unconscious"], "Condition": ["Aflame", "Angered", "Chilled", "Delayed", "Disgusted", "Dying", "Empowered", "Encouraged", "Encumbered", "Frightened", "Hasted", "Immobilized", "Impaired", "Joyful", "Launched", "Paralyzed", "Prone", "Saddened", "Sickened", "Staggered", "Stunned", "Surprised"], "Skill": ["Acrobatics", "Agility", "Analyze", "Build", "Channel", "Charm", "Command", "Concoct", "Cook", "Deception", "Disguise", "Empathy", "Enchant", "Finesse", "Flexibility", "Grappling", "Heal", "Intimidation", "Leadership", "Maneuver", "Medicine", "Might", "Negotiation", "Palming", "Physique", "Pilot", "Resonance", "Search", "Shoot", "Skirmish", "Sneak", "Survival", "Throw", "Tinker", "Traversal", "Generalist", "Defender", "Athlete", "Skirmisher", "Marksman"], "Language": ["Minere", "Junal", "Apollen", "Lib", "Cert", "Byric", "Dustell", "Muralic", "Shira", "Ciel", "Citeq", "Manstan", "Salkan", "Sansic", "Silq", "Kleikan", "Crinere", "Palmic", "Shorespeak", "Verdeni", "Vulca", "Emotion", "Wolfwarg", "Jovean", "Mytikan"], "Lore": ["Academics", "Health", "Mana", "Mathematics", "Nature", "School", "Spirit", "Warfare", "Zoology", "Profession", "Farming", "Fishing", "Hunting", "Legal", "Mercantile", "Mining", "Craftmanship", "Alchemy", "Architecture", "Brewing", "Cooking", "Engineering", "Glassblowing", "Leatherworking", "Sculpting", "Smithing", "Weaving", "Geography", "Aridsha", "Ceres", "Colswei", "Khem", "Novus", "Walthair", "Wayling", "Ethereal Plane", "History", "Aridsha History", "Ceres History", "Colswei History", "Khem History", "Novus History", "Walthair History", "Wayling History", "Culture", "Art", "Etiquette", "Fashion", "Games", "Music", "Scribing", "Theater", "Religion", "Church of Kongkwei", "Guidance", "Life's Circle", "Ocean Court", "Sylvan", "Zushaon", "Trainee", "Interceptor", "Guardian", "Spellslinger", "Warrior", "Rogue", "Scholar", "Physician"] } },
		_max = "_max",
		_rank = "_rank",
		_build = _build,
		_filter = "_filter",
