	...
	var
		...
		values = {
			...
			"AttributeValueAverage": {
				"name": "AttributeValueAverage", "title": "Average (+0)", "group": "AttributeValue", "descriptions": [""],
				"abbreviation": "", "variable": "0", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"AttributeValueGreat": {
				"name": "AttributeValueGreat", "title": "Great (+3)", "group": "AttributeValue", "descriptions": [""],
				"abbreviation": "", "variable": "3", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"AttributeValueGood": {
				"name": "AttributeValueGood", "title": "Good (+2)", "group": "AttributeValue", "descriptions": [""],
				"abbreviation": "", "variable": "2", "formula": "", "modifiers": "", "linkedGroups": 1, "modAttrs": [],
				"formulaCalculations": []
			},
			"AttributeValueBad": {
				"name": "AttributeValueBad", "title": "Bad (-1)", "group": "AttributeValue", "descriptions": [""],
			...
			"Style:Basic Set": {
				"name": "Style:Basic Set", "title": "Basic Set", "group": "Style", "descriptions": ["A standard list of techniques. Anyone can perform these techniques. "],
				"abbreviation": "", "variable": "basicSet", "formula": "", "modifiers": "", "linkedGroups": [],
				"modAttrs": [],
				"formulaCalculations": []
			},
			"Style:Swordplay": {
				"name": "Style:Swordplay", "title": "Swordplay", "group": "Style", "descriptions": ["Swords go brrr"],
				"abbreviation": "", "variable": "swordplay", "formula": "", "modifiers": "", "linkedGroups": [],
				"modAttrs": [],
				"formulaCalculations": []
			},
			"Style:Ki Extension": {
				"name": "Style:Ki Extension", "title": "Ki Extension", "group": "Style", "descriptions": ["Ki makes things longer"],
				"abbreviation": "", "variable": "kiExtension", "formula": "", "modifiers": "", "linkedGroups": [],
				"modAttrs": [],
				"formulaCalculations": []
			},
			"Skill:Acrobatics": {
