...
var WuxDef = WuxDef || (function () {
	...
	var
		...
		values = {
			...
			"Soc_Approval": {
				"name": "Soc_Approval", "fieldName": "approval", "group": "Social", "description": "", "variable": "soc-approval{0}", "title": "Approval", "subGroup": "", "descriptions": ["Approval is a character's resistance to place their trust in another. In social conflict it acts similarly to HP, representing a character's threshold before allowing another to have their favor. ", "Approval should be set based on the argument made during an Influence check. ", "5-15. This is a low approval rating. It is very easy to persuade this character with the argument put forth.", "16-30. The character is unwilling to immediately budge on the subject but a little persuasion should work them over.", "31-45. This is a subject the character will be difficult to persuade to change.", "46+. A very difficult ask to make from the character."],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
			...
			"Stat_Dying": {
				"name": "Stat_Dying", "fieldName": "dying", "group": "Status", "description": "", "variable": "sts-dying{0}", "title": "Dying", "subGroup": "Condition", "descriptions": ["At the start of each round, a dying creature takes 1 stress."],
				"abbreviation": "", "baseFormula": "", "modifiers": "", "formula": { "workers": [] },
				"linkedGroups": [],
				"isResource": ""
			},
